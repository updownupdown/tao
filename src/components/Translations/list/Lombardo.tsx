export const text = [
  {
    chapter: 1,
    content: `Tao called Tao is not Tao. Names can name no lasting name.
...
Call them both deep - Deep and again deep: the gateway to all mystery.`,
  ...
  {
    chapter: 2,
    content: `Recognize beauty and ugliness is born.
...
Accomplishes without taking credit. When no credit is taken, Accomplishment endures.`,
  ...
  {
    chapter: 3,
    content: `Don't glorify heroes, And people will not contend.
...
Practices non-action And the natural order is not disrupted.`,
  ...
  {
    chapter: 4,
    content: `Tao is empty- its use never exhausted.
...
I don't know whose child it is. It is older than the Ancestor.`,
  ...
  {
    chapter: 5,
    content: `Heaven and Earth are not kind: The ten thousand things are straw dogs to them.
...
Self is fulfilled?`,
  ...
  {
    chapter: 8,
    content: `Best to be like water, Which benefits the ten thousand things And does not contend. It pools where humans disdain to dwell, Close to the Tao.
...
Only do not contend, And you will not go wrong.`,
  ...
  {
    chapter: 9,
    content: `Hold and fill it - No as good as stopping in time.
...
Withdrawing when work is done: Heaven's Tao.`,
  ...
  {
    chapter: 10,
    content: `Can you balance your life force And embrace the One Without separation?
...
Give birth and cultivate. Give birth and do not possess. Act without dependence. Excel but do not rule. This is called the dark Te.`,
  ...
  {
    chapter: 11,
    content: `Thirty spokes join one hub. The wheel's use comes from emptiness.
...
Therefore, Having leads to profit, Not having leads to use.`,
  ...
  {
    chapter: 12,
    content: `Five colors darken the eyes. Five tones darken the ears. Five tastes jade the palate.
...
Therefore the Sage Takes care of the belly, not the eye, Chooses one, rejects the other.`,
  ...
  {
    chapter: 13,
    content: `Favour and disgrace are like fear. Honour and distress are like the self.
...
Respect the world as your self: The world can be your lodging. Love the world as your self: The world can be your trust.`,
  ...
  {
    chapter: 14,
    content: `Seeing but not seeing, we call it dim. Listening but not hearing, we call it faint. Groping but not touching, we call it subtle.
...
Live in the ancient Tao, Master the existing present, Understand the source of all things. This is called the record of Tao.`,
  ...
  {
    chapter: 15,
    content: `The ancients who followed Tao: Dark, wondrous, profound, penetrating. Deep beyond knowing.
...
Those who sustain Tao Do not wish to be full. Because they do not wish to be full They can fade away Without further effort.`,
  ...
  {
    chapter: 16,
    content: `Attain complete emptiness, Hold fast to stillness.
...
Tao endures. Your body dies. There is no danger.`,
  ...
  {
    chapter: 17,
    content: `Great rising and falling - People only know it exists. Next they see and praise. Soon they fear. Finally they despise.
...
When the work is done, Everyone says We just acted naturally.`,
  ...
  {
    chapter: 18,
    content: `Great Tao rejected: Benevolence and righteousness appear.
...
The nation disordered: Patriots come forth.`,
  ...
  {
    chapter: 19,
    content: `Banish learning, discard knowledge: People will gain a hundredfold.
...
Look at plain silk; hold uncarved wood. The self dwindles; desires fade.`,
  ...
  {
    chapter: 20,
    content: `Banish learning, no more grief. Between Yes and No How much difference? Between good and evil How much difference??
...
Others have plans, I alone am wayward and stubborn, I alone am different from others, Like a baby in the womb.`,
  ...
  {
    chapter: 21,
    content: `Great Te appears Flowing from Tao.
...
How do I know these origins? Like this.`,
  ...
  {
    chapter: 22,
    content: `Crippled become whole, Crooked becomes straight, Hollow becomes full, Worn becomes new, Little becomes more, Much becomes delusion.
...
The old saying Crippled becomes whole Is not empty words. It becomes whole and returns.`,
  ...
  {
    chapter: 23,
    content: `Spare words; nature's way. Violent winds do not blow all morning. Sudden rain cannot pour all day.
...
Without trust in this, There is no trust at all.`,
  ...
  {
    chapter: 24,
    content: `Upon tiptoe: no way to stand. Clambering: no way to walk.
...
According to Tao, Excessive food, Extraneous activity Inspire disgust. Therefore the follower of Tao Moves on.`,
  ...
  {
    chapter: 25,
    content: `Something unformed and complete Before heaven and Earth were born, Solitary and silent, Stands alone and unchanging. Pervading all things without limit. It is like the mother of all things under heaven,
...
Humans follow earth Earth follows heaven Heaven follows Tao. Tao follows its own nature.`,
  ...
  {
    chapter: 26,
    content: `Gravity is the root of lightness, Stillness the master of passion.
...
Lightness loses its root, Passion loses its master.`,
  ...
  {
    chapter: 27,
    content: `Good travelers leave no tracks. Good words leave no trace. Good counting needs no markers.
...
Not to value the teacher, Not to love the resource, Causes great confusion even for the intelligent. This is called the vital secret.`,
  ...
  {
    chapter: 28,
    content: `Know the male, maintain the female, Become the channel of the world, And Te will endure. Return to infancy.
...
Simplicity divided becomes utensils That are used by the Sage as high official. But great governing does not carve up.`,
  ...
  {
    chapter: 29,
    content: `Trying to control the world? I see you won't succeed.
...
Therefore the Sage Casts off extremes, Casts off excess, Casts off Extravagance.`,
  ...
  {
    chapter: 30,
    content: `Use Tao to help rule people. This world has no need for weapons, Which soon turn on themselves.
...
If these things prosper and grow old, This is called not-Tao. Not-Tao soon ends.`,
  ...
  {
    chapter: 31,
    content: `Fine weapons are ill-omened tools. They are hated. Therefore the old Tao ignores them.
...
When many people are killed We feel sorrow and grief. A great victory Is a funeral ceremony.`,
  ...
  {
    chapter: 32,
    content: `Tao endures without a name. Though simple and slight, No one under heaven can master it.
...
Tao's presence in this world Is like valley streams Flowing into rivers and seas.`,
  ...
  {
    chapter: 33,
    content: `Knowing others is intelligent. Knowing yourself is enlightened.
...
Hold your ground and you will last long. Die without perishing and your life will endure.`,
  ...
  {
    chapter: 34,
    content: `Great Tao overflows. To the left To the right.
...
By not making itself great, It can do great things.`,
  ...
  {
    chapter: 35,
    content: `Hold the great elephant - The great image - And the world moves. Moves without danger in safety and peace.
...
But the Tao emerges Flavourless and bland. Look - you won't see it. Listen - You won't hear it. Use it - You will never use it up.`,
  ...
  {
    chapter: 36,
    content: `To collect, first scatter. To Weaken, first strengthen. To abolish, first establish. To conclude, first initiate.
...
Fish cannot escape the deep pool. A country's sharpest weapons Cannot be displayed.`,
  ...
  {
    chapter: 37,
    content: `Tao endures without a name, Yet nothing is left undone.
...
No desire is serenity, An the world settles of itself.`,
  ...
  {
    chapter: 38,
    content: `High Te? No Te! That's what Te is. Low Te doesn't lack Te; That's what Te is not.
...
And so the ideal person dwells In substance, not dilution, In reality, not glory, Accepts one, rejects the other.`,
  ...
  {
    chapter: 39,
    content: `Of old, these attained the One: Heaven attaining the One Became clear. Earth attaining the One Became stable. Spirits attaining the One Became sacred.
...
They do not desire to glisten like jade But drop like a stone.`,
  ...
  {
    chapter: 40,
    content: `Reversal is Tao's movement. Yielding is Tao's practice.
All things originate from being. Being originates from non-being.`,
  },
  {
    chapter: 41,
    content: `The great scholar hearing the Tao Tries to practice it. The middling scholar hearing the Tao, Sometimes has it, sometimes not.
...
Tao hides, no name. Yet Tao alone gets things done.`,
  ...
  {
    chapter: 42,
    content: `Tao engenders One, One engenders Two, Two engenders Three, Three engenders the ten thousand things.
...
What others teach, I also teach: "A violent man does not die a natural death. This is the basis of my teaching.`,
  ...
  {
    chapter: 43,
    content: `The softest thing in the world rides roughshod over the strongest. No-thing enters no-space. This teaches me the benefits of no-action.
Teaching without words Benefit without action - Few in this world can attain this.`,
  },
  {
    chapter: 44,
    content: `Name or body: which is closer? Body or possessions: which means more? Gain or loss: Which one hurts?
...
Know what is enough - Abuse nothing. Know when to stop - Harm nothing. This is how to last for a long time.`,
  ...
  {
    chapter: 45,
    content: `Great accomplishment seems unfinished But its use is continuous. Great fullness seems empty But in use is inexhaustible.
...
Exertion overcomes cold. Calm overcomes heat. Pure calm is the norm under heaven.`,
  ...
  {
    chapter: 46,
    content: `With Tao under heaven Stray horses fertilize the fields. Without Tao under heaven Warhorses are bred at the frontier.
...
Therefore, Knowing that enough is enough Is always Enough.`,
  ...
  {
    chapter: 47,
    content: `Without going out the door, Know the world. Without peeping through the window, See heaven's Tao. The further you travel, The less you know.
This is why the Sage Knows without budging, Identifies without looking, Does without trying.`,
  },
  {
    chapter: 48,
    content: `Pursue knowledge, gain daily. Pursue Tao, lose daily. Lose and again lose, Arrive at non-doing.
Non-doing - and nothing not done.
Take the entire world as nothing. Make the least effort, And the world escapes you.`,
  },
  {
    chapter: 49,
    content: `The Sage has no set heart. Ordinary people's hearts Become the Sage's heart.
...
Sages create harmony under heaven Blending their hearts with the world. Ordinary people fix their eyes and ears upon them, But Sages become the world's children.`,
  ...
  {
    chapter: 50,
    content: `Emerge into life, enter death,
...
Bears them without owning them, Helps them without coddling them, Rears them without ruling them. This is called original Te.`,
  ...
  {
    chapter: 52,
    content: `The world has a source: the world's mother. Once you have the mother, You know the children.
...
Use this brightness to return to brightness. Don't cling to your body's woes. Then you can learn endurance.`,
  ...
  {
    chapter: 53,
    content: `Having some knowledge When walking on the Great Tao Only brings fear.
...
But the nobles clothes are gorgeous, Their belts show off swords, And they are glutted with food and drink. Personal wealth is excessive. This is called thieves' endowment, But it is not Tao.`,
  ...
  {
    chapter: 54,
    content: `Well planted, not uprooted. Well embraced, never lost. Descendants will continue The ancestral rituals.
...
How do I know the world? Like this!`,
  ...
  {
    chapter: 55,
    content: `Be filled with Te, Like a baby: Wasps, scorpions and vipers Do not sting it. Fierce tigers do not stalk it. Birds of prey do not attack it. Bones weak, muscles soft, But its grasp is tight.
...
When beings prosper and grow old, Call them not-Tao. Not-Tao soon ends.`,
  ...
  {
    chapter: 56,
    content: `Those who know don't talk. Those who talk don't know.
...
It can't be embraced It can't be escaped, It can't be helped It can't be harmed, It can't be exalted It can't be despised, Therefore it is revered under Heaven.`,
  ...
  {
    chapter: 57,
    content: `Use the unexpected to govern the country, Use surprise to wage war, Use non-action to win the world. How do I know? Like this!
...
I cultivate emptiness And people become prosperous. I have no desires And people simplify themselves.`,
  ...
  {
    chapter: 58,
    content: `If government is muted and muffled People are cool and refreshed. If government investigates and intrudes, People are worn down and hopeless.
...
Therefore the Sage squares without cutting, Corners without dividing, Straightens without extending, Shines without dazzling.`,
  ...
  {
    chapter: 59,
    content: `Governing people and serving heaven Is like living off the land.
...
This is called deep roots, firm base. This is the Tao of living long and seeing far.`,
  ...
  {
    chapter: 60,
    content: `Govern big countries Like you cook a little fish.
...
If neither does harm, Then Te flows and returns.`,
  ...
  {
    chapter: 61,
    content: `A great nation flows down To be the world's pool, The female under heaven In stillness The female constantly overcomes the male, In stillness Takes the low place.
...
When both get what they wish The great one should be low.`,
  ...
  {
    chapter: 62,
    content: `Tao is the mysterious center of all things, a treasure for those who are good, A refuge for those who are not.
...
The ancients honoured this Tao. Didn't they say: Through it seekers find, Through it the guilty escape? This is why Tao is honoured under Heaven.`,
  ...
  {
    chapter: 63,
    content: `Act without acting. Serve without serving. Taste without tasting.
...
Thus for the Sage everything is difficult, And so in the end Nothing is difficult.`,
  ...
  {
    chapter: 64,
    content: `At rest is easy to hold. Not yet impossible is easy to plan. Brittle is easy to break. Fine is easy to scatter.
...
Therefore the Sage Desires no desires Prizes no prizes Studies no studies And returns To what others pass by. The Sage Helps all beings find their nature, But does not presume to act.`,
  ...
  {
    chapter: 65,
    content: `Taoist rulers of old Did not enlighten people But left them dull.
...
Original Te goes deep and far. All things reverse Return And reach the great headwaters.`,
  ...
  {
    chapter: 66,
    content: `Rivers and seas Can rule the hundred valleys Because they are good at lying low They are lords of the valleys.
...
Since the Sage does not contend No one can contend with the Sage.`,
  ...
  {
    chapter: 67,
    content: `Everyone under heaven calls my Tao great, and unlike anything else. It is great only because It is unlike anything else. If it were like anything else It would stretch and become thin.
...
Compassion: Attack with it and win. Defend with it and stand firm. Heaven aids and protects Through compassion.`,
  ...
  {
    chapter: 68,
    content: `The accomplished person is not aggressive. The good soldier is not hot tempered.
...
This is called the Te of not contending. This is called the power of the leader. This is called matching Heaven's ancient ideal.`,
  ...
  {
    chapter: 69,
    content: `There is a saying in the army: I do not presume to be the master, But become the guest. I do not dare advance an inch, but retreat a foot.
...
Contempt for the enemy - what a treasure is lost! Therefore, When the fighting gets hot, Those who grieve will conquer.`,
  ...
  {
    chapter: 70,
    content: `My words are very easy to understand, Very easy to practice. No one under heaven can understand them, No one can practice them.
...
Therefore the Sage wears rough clothing And carries Jade inside.`,
  ...
  {
    chapter: 71,
    content: `Know not-knowing: supreme. Not know knowing: faulty
...
And so is without fault.`,
  ...
  {
    chapter: 72,
    content: `When people are not in awe of power, Power becomes great.
...
Therefore the Sage Has self-knowledge without self-display, Self-love without personal pride, Rejects one, accepts the other.`,
  ...
  {
    chapter: 73,
    content: `Courage to dare kills, Courage not to dare saves. One brings profit, one brings harm.
...
Heaven's net is wide, wide, Loose - But nothing slips through.`,
  ...
  {
    chapter: 74,
    content: `If people do not fear death, How dare you threaten them with death?
...
There is always an official executioner. Trying to take the executioner's place, Is like trying to replace a master woodworker - Few would not slice their own hands.`,
  ...
  {
    chapter: 75,
    content: `People are hungry. When rulers tax grain People are hungry.
...
People ignore death. When searching only for life's bounty People ignore death. Only those who do not strive after life Truly respect life.`,
  ...
  {
    chapter: 76,
    content: `Humans are born soft and weak. They die stiff and strong.
...
The strong and great sink down. The soft and weak rise up.`,
  ...
  {
    chapter: 77,
    content: `Heaven's Tao Is a stretched bow, Pulling down on the top Pulling up on the bottom.
...
Therefore the Sage Acts and expects nothing, Accomplishes and does not linger, Has no desire to seem worthy.`,
  ...
  {
    chapter: 78,
    content: `Nothing in the world is soft and weak as water. But when attacking the hard and strong Nothing can conquer so easily.
...
Therefore the Sage says: Accept a country's filth And become master of its sacred soil. Accepts country's ill fortune And become king under heaven. True words resemble their opposites.`,
  ...
  {
    chapter: 79,
    content: `Appears great hatred sand hatred will remain. How can this be good?
...
Heaven has no favourites But endures in good people.`,
  ...
  {
    chapter: 80,
    content: `Small country, few people - Hundreds of devices, But none are used. People ponder on death And don't travel far.
...
Neighboring countries are so close You can hear their chickens and dogs. But people grow old and die Without needing to come and go.`,
  ...
  {
    chapter: 81,
    content: `Sincere words and not pretty. Pretty words are not sincere.
