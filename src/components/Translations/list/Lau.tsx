...
The gateway of the manifold secrets.`,
  ...
  {
    chapter: 2,
    content: `The whole world recognizes the beautiful as the beautiful, yet this is only the ugly;
...
That its merit never deserts it.`,
  ...
  {
    chapter: 3,
    content: `Not to honor men of worth will keep the people from contention;
...
Do that which consists in taking no action, and order will prevail.`,
  ...
  {
    chapter: 4,
    content: `The way is empty, yet use will not drain it.
...
It images the forefather of God.`,
  ...
  {
    chapter: 5,
    content: `Heaven and earth are ruthless, and treat the myriad creatures as straw dogs;
...
Yet use will never drain it.`,
  ...
  {
    chapter: 7,
    content: `Heaven and earth are enduring.
...
Is it not because he is without thought of self that he is able to accomplish his private ends?`,
  ...
  {
    chapter: 8,
    content: `Highest good is like water.
...
It is because it does not contend that it is never at fault.`,
  ...
  {
    chapter: 9,
    content: `Rather than fill it to the brim by keeping it upright
...
Is the way of heaven.`,
  ...
  {
    chapter: 10,
    content: `When carrying on your head your perplexed bodily soul
...
Such is called the mysterious virtue.`,
  ...
  {
    chapter: 11,
    content: `Thirty spokes share one hub.
...
Thus what we gain is Something, yet it is by virtue of Nothing that this can be put to use.`,
  ...
  {
    chapter: 12,
    content: `The five colors make man's eyes blind;
...
Therefore he discards the one and takes the other.`,
  ...
  {
    chapter: 13,
    content: `Favor and disgrace are things that startle;
...
He who loves his body more than dominion over the empire can be given the custody of the empire.`,
  ...
  {
    chapter: 14,
    content: `What cannot be seen is called evanescent;
...
Is called the thread running through the way.`,
  ...
  {
    chapter: 15,
    content: `Of old he who was well versed in the way
...
That he can be worn and yet newly made.`,
  ...
  {
    chapter: 16,
    content: `I do my utmost to attain emptiness;
...
And to the end of one's days one will meet with no danger.`,
  ...
  {
    chapter: 17,
    content: `The best of all rulers is but a shadowy presence to his subjects.
...
The people all say, 'It happened to us naturally.'`,
  ...
  {
    chapter: 18,
    content: `When the great way falls into disuse
...
There are loyal ministers.`,
  ...
  {
    chapter: 19,
    content: `Exterminate learning and there will no longer be worries.
...
And value being fed by the mother.`,
  ...
  {
    chapter: 21,
    content: `In his every movement a man of great virtue
...
By means of this.`,
  ...
  {
    chapter: 22,
    content: `Bowed down then preserved;
Bent then straight;
Hollow then full;
Worn then new;
...
Truly it enables one to be preserved to the end.`,
  ...
  {
    chapter: 23,
    content: `To use words but rarely
Is to be natural.
...
When there is not enough faith, there is lack of good faith.`,
  ...
  {
    chapter: 24,
    content: `He who tiptoes cannot stand; he who strides cannot walk.
...
As there are Things that detest them, he who has the way does not abide in them.`,
  ...
  {
    chapter: 25,
    content: `There is a thing confusedly formed,
...
And the way on that which is naturally so.`,
  ...
  {
    chapter: 26,
    content: `The heavy is the root of the light;
...
If restless, then the lord is lost.`,
  ...
  {
    chapter: 27,
    content: `One who excels in travelling leaves no wheel tracks;
...
Hence the greatest cutting does not sever.`,
  ...
  {
    chapter: 29,
    content: `Whoever takes the empire and wishes to do anything to it I see will have no respite.
...
Therefore the sage avoids excess, extravagance, and arrogance.`,
  ...
  {
    chapter: 30,
    content: `One who assists the ruler of men by means of the way does not intimidate the empire by a show of arms.
...
That which goes against the way will come to an early end.`,
  ...
  {
    chapter: 31,
    content: `It is because arms are instruments of ill omen and there are Things that detest them that the one who has the way does not abide by their use.
...
When victorious in war, one should observe the rites of mourning.`,
  ...
  {
    chapter: 32,
    content: `The way is for ever nameless.
...
The way is to the world as the River and the Sea are to rivulets and streams.`,
  ...
  {
    chapter: 33,
    content: `He who knows others is clever;
...
He who lives out his days has had a long life.`,
  ...
  {
    chapter: 34,
    content: `The way is broad, reaching left as well as right.
...
It is because it never attempts itself to become great that it succeeds in becoming great.`,
  ...
  {
    chapter: 35,
    content: `Have in your hold the great image
...
Yet it cannot be exhausted by use.`,
  ...
  {
    chapter: 36,
    content: `If you would have a thing shrink,
...
The instruments of power in a state must not be revealed to anyone.`,
  ...
  {
    chapter: 37,
    content: `The way never acts, yet nothing is left undone.
Should lords and princes be able to hold fast to it,
...
The empire will be at peace of its own accord.`,
  ...
  {
    chapter: 38,
    content: `A man of the highest virtue does not keep to virtue and that is why he has virtue.
...
Therefore he discards the one and takes the other.`,
  ...
  {
    chapter: 39,
    content: `Of old, these came to be in possession of the One:
...
Nor to be aloof like stone.`,
  ...
  {
    chapter: 40,
    content: `Turning back is how the way moves;
...
Something, and Something from Nothing.`,
  ...
  {
    chapter: 41,
    content: `When the best student hears about the way
...
The teaching that uses no words, the benefit of resorting to no action, these are beyond the understanding of all but a very few in the world.`,
  ...
  {
    chapter: 44,
    content: `Your name or your person,
Which is dearer?
...
You can then endure.`,
  ...
  {
    chapter: 45,
    content: `Great perfection seems chipped,
...
One can be a leader in the empire.`,
  ...
  {
    chapter: 46,
    content: `When the way prevails in the empire, fleet-footed horses are relegated to ploughing in the fields;
...
Hence in being content, one will always have enough.`,
  ...
  {
    chapter: 47,
    content: `Without stirring abroad
...
Accomplishes without having to act.`,
  ...
  {
    chapter: 48,
    content: `In the pursuit of learning one knows more every day;
...
Should you meddle, then you are not equal to the task of winning the empire.`,
  ...
  {
    chapter: 49,
    content: `The sage has no mind of his own.
...
The people all have something to occupy their eyes and ears, and the sage treats them all like children.`,
  ...
  {
    chapter: 50,
    content: `When going one way means life and going the other means death, three in ten will be comrades in life, three in ten will be comrades in death, and there are those who value life and as a result move into the realm of death, and these also number three in ten.
...
Why is this so? Because for him there is no realm of death.`,
  ...
  {
    chapter: 51,
    content: `The way gives them life;
Virtue rears them;
...
This is known as following the constant.`,
  ...
  {
    chapter: 53,
    content: `Were I possessed of the least knowledge, I would, when walking on the great way, fear only paths that lead astray.
...
Far indeed is this from the way.`,
  ...
  {
    chapter: 54,
    content: `What is firmly rooted cannot be pulled out;
...
By means of this.`,
  ...
  {
    chapter: 55,
    content: `One who possesses virtue in abundance is comparable to a new born babe:
...
That which goes against the way will come to an early end.`,
  ...
  {
    chapter: 56,
    content: `One who knows does not speak;
...
Therefore it is valued by the empire.`,
  ...
  {
    chapter: 57,
    content: `Govern the state by being straightforward;
...
I am free from desire and the people of themselves become simple like the uncarved block.`,
  ...
  {
    chapter: 58,
    content: `When the government is muddled
...
Shines but does not dazzle.`,
  ...
  {
    chapter: 59,
    content: `In ruling the people and in serving heaven it is best for a ruler to be sparing.
...
This is called the way of deep roots and firm stems by which one lives to see many days.`,
  ...
  {
    chapter: 60,
    content: `Governing a large state is like boiling a small fish.
...
As neither does any harm, each attributes the merit to the other.`,
  ...
  {
    chapter: 61,
    content: `A large state is the lower reaches of a river:
...
It is meet that the large should take the lower position.`,
  ...
  {
    chapter: 62,
    content: `The way is the refuge for the myriad creatures.
...
Therefore it is valued by the empire.`,
  ...
  {
    chapter: 63,
    content: `Do that which consists in taking no action;
...
That is why in the end no difficulties can get the better of him.`,
  ...
  {
    chapter: 64,
    content: `It is easy to maintain a situation while it is still secure;
...
In order to help the myriad creatures to be natural and to refrain from daring to act.`,
  ...
  {
    chapter: 65,
    content: `Of old those who excelled in the pursuit of the way did not use it to enlighten the people but to hoodwink them.
...
Only then is complete conformity realized.`,
  ...
  {
    chapter: 66,
    content: `The reason why the River and the Sea are able to be king of the hundred valleys is that they excel in taking the lower position.
...
It is because he does not contend that no one in the empire is in a position to contend with him.`,
  ...
  {
    chapter: 67,
    content: `The whole world says that my way is vast and resembles nothing.
...
What heaven succours it protects with the gift of compassion.`,
  ...
  {
    chapter: 68,
    content: `One who excels as a warrior does not appear formidable;
...
This is known as matching the sublimity of heaven.`,
  ...
  {
    chapter: 69,
    content: `The strategists have a saying,
...
It is the one that is sorrow-stricken that wins.`,
  ...
  {
    chapter: 70,
    content: `My words are very easy to understand and very easy to put into practice,
...
Therefore the sage, while clad in homespun, conceals on his person a priceless piece of jade.`,
  ...
  {
    chapter: 71,
    content: `To know yet to think that one does not know is best;
...
It is because he is alive to it that he meets with no difficulty.`,
  ...
  {
    chapter: 72,
    content: `When the people lack a proper sense of awe, then some awful visitation will descend upon them.
...
Therefore he discards the one and takes the other.`,
  ...
  {
    chapter: 73,
    content: `He who is fearless in being bold will meet with his death;
...
Though the mesh is not fine, yet nothing ever slips through.`,
  ...
  {
    chapter: 74,
    content: `When the people are not afraid of death, wherefore frighten them with death?
...
It is just because one has no use for life that one is wiser than the man who values life.`,
  ...
  {
    chapter: 76,
    content: `A man is supple and weak when living, but hard and stiff when dead.
...
The supple and weak takes the higher position.`,
  ...
  {
    chapter: 77,
    content: `Is not the way of heaven like the stretching of a bow?
...
Is this not because he does not wish to be considered a better man than others?`,
  ...
  {
    chapter: 78,
    content: `In the world there is nothing more submissive and weak than water.
...
It is for ever on the side of the good man.`,
  ...
  {
    chapter: 80,
    content: `Reduce the size of the population and the state.
...
yet the people of one state will grow old and die without having had any dealings with those of another.`,
  ...
  {
    chapter: 81,
    content: `Truthful words are not beautiful;
