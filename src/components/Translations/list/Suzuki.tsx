export const text = [
  {
    chapter: 1,
    content: `The Reason that can be reasoned is not the eternal Reason. The name that can be named is not the eternal Name. The Unnamable is of heaven and earth the beginning. The Namable becomes of the ten thousand things the mother.
...
These two things are the same in source but different in name. Their sameness is called a mystery. Indeed, it is the mystery of mysteries. Of all spirituality it is the door.`,
  ...
  {
    chapter: 2,
    content: `Everywhere it is obvious that if beauty makes a display of beauty, it is sheer ugliness. It is obvious that if goodness makes a display of goodness, it is sheer badness. For
...
It will never leave him."`,
  ...
  {
    chapter: 3,
    content: `Not boasting of one's worth forestalls people's envy.
...
Therefore the holy man when he governs empties the people's hearts but fills their stomachs. He weakens their ambition but strengthens their bones. Always he keeps the people unsophisticated and without desire. He causes that the crafty do not dare to act. When he acts with non-assertion there is nothing ungoverned.`,
  ...
  {
    chapter: 4,
    content: `Reason is empty, but its use is inexhaustible. In its profundity, verily, it resembleth the arch-father of the ten thousand things.
...
Oh, how calm it seems to remain! I know not whose son it is. Apparently even the Lord it precedes.`,
  ...
  {
    chapter: 5,
    content: `But for heaven and earth's humaneness, the ten thousand things are straw dogs. But for the holy man's humaneness, the hundred families are straw dogs.
...
On the middle path to walk?"`,
  ...
  {
    chapter: 6,
    content: `"The valley spirit not expires,
...
And its use is without effort sure."`,
  ...
  {
    chapter: 7,
    content: `Heaven endures and earth is lasting. And why can heaven and earth endure and be lasting? Because they do not live for themselves. On that account can they endure.
...
The holy man puts his person behind and his person comes to the front. He surrenders his person and his person is preserved. Is it not because he seeks not his own? For that reason he can accomplish his own.`,
  ...
  {
    chapter: 8,
    content: `Superior goodness resembleth water. The water's goodness benefiteth the ten thousand things, yet it quarreleth not.
...
It quarreleth not. Therefore it is not rebuked.`,
  ...
  {
    chapter: 9,
    content: `Grasp to the full, are you not likely foiled? Scheme too sharply, can you wear long? If gold and jewels fill the hall no one can protect it.
...
Rich and high but proud, brings about its own doom. To accomplish merit and acquire fame, then to withdraw, that is Heaven's Way.`,
  ...
  {
    chapter: 10,
    content: `Who by unending discipline of the senses embraces unity cannot be disintegrated. By concentrating his vitality and inducing tenderness he can become like a little child. By purifying, by cleansing and profound intuition he can be free from faults.
...
The holy man attends to the inner and not to the outer. He abandons the latter and chooses the former.`,
  ...
  {
    chapter: 13,
    content: `"Favor bodes disgrace; it is like trembling.
...
Therefore who administers the empire as he takes care of his body can be entrusted with the empire.`,
  ...
  {
    chapter: 14,
    content: `We look at Reason and do not see it; its name is Colorless. We listen to Reason and do not hear it; its name is Soundless. We grope for Reason and do not grasp it; its name is Bodiless.
...
By holding fast to the Reason of the ancients, the present is mastered and the origin of the past understood. This is called Reason's clue.`,
  ...
  {
    chapter: 15,
    content: `Those of yore who have succeeded in becoming masters are subtile, spiritual, profound, and penetrating. On account of their profundity they can not be understood. Because they can not be understood, therefore I endeavor to make them intelligible.
...
He who cherishes this Reason is not anxious to be filled. Since he is not filled, therefore he may grow old; without renewal he is complete.`,
  ...
  {
    chapter: 16,
    content: `By attaining the height of abstraction we gain fulness of rest.
...
Knowing the eternal renders comprehensive. Comprehensiveness renders broad. Breadth renders royal. Royalty renders heavenly. Heaven renders Reason-like. Reason renders lasting. Thus the decay of the body implies no danger.`,
  ...
  {
    chapter: 17,
    content: `Of great rulers the subjects do not notice the existence. To lesser ones people are attached; they praise them. Still lesser ones people fear, and the meanest ones people despise.
...
How reluctantly they [the great rulers] considered their words! Merit they accomplished; deeds they performed; and the hundred families thought: "We are independent."`,
  ...
  {
    chapter: 18,
    content: `When the great Reason is obliterated, we have benevolence and justice. Prudence and circumspection appear, and we have much hypocrisy.
...
When family relations no longer harmonize, we have filial piety and paternal devotion. When the country and the clans decay through disorder, we have loyalty and allegiance.`,
  ...
  {
    chapter: 19,
    content: `Abandon your saintliness; put away your prudence; and the people will gain a hundredfold!
...
And lessen self with desires fewer."`,
  ...
  {
    chapter: 20,
    content: `Abandon learnedness, and you have no vexation. The "yes" compared with the "yea," how little do they differ! But the good compared with the bad, how much do they differ!
...
Through what do I know that "it heeds the good of everything"? In this way, verily: Through IT.`,
  ...
  {
    chapter: 22,
    content: `"The crooked shall be straight,
...
The saying of the ancients: "The crooked shall be straight," is it in any way vainly spoken? Verily, they will be straightened and return home.`,
  ...
  {
    chapter: 23,
    content: `To be taciturn is the natural way. A hurricane: does not outlast the morning. A cloudburst does not outlast the day.
...
"If your faith is insufficient, verily shall ye receive no faith."`,
  ...
  {
    chapter: 24,
    content: `One on tiptoe is not steady;
...
Therefore the man of reason will not indulge in it.`,
  ...
  {
    chapter: 25,
    content: `There is a Being wondrous and complete. Before heaven and earth, it was. How calm it is! How spiritual!
...
Man's standard is the earth. The earth's standard is heaven. Heaven's standard is Reason. Reason's standard is intrinsic.`,
  ...
  {
    chapter: 26,
    content: `The heavy is of the light the root, and rest is motion's master.
...
But how is it when the master of the ten thousand chariots in his personal conduct is too light for the empire? If he is too light he will lose his vassals. If he is too passionate he will lose the throne.`,
  ...
  {
    chapter: 27,
    content: `"Good travelers leave no trace nor track,
...
Simplicity, when scattered, becomes a vessel of usefulness. The holy man, by using it, becomes the chief leader; and truly, a great principle will never do harm.`,
  ...
  {
    chapter: 29,
    content: `When one desires to take in hand the empire and make it, I see him not succeed. The empire is a divine vessel which cannot be made. One who makes it, mars it. One who takes it, loses it.
...
Therefore the holy man abandons excess, he abandons extravagance, he abandons indulgence.`,
  ...
  {
    chapter: 30,
    content: `He who with Reason assists the master of mankind will not with arms strengthen the empire. His methods invite requital.
...
Things thrive and then grow old. This is called un-Reason. Un-Reason soon ceases.`,
  ...
  {
    chapter: 31,
    content: `Even victorious arms are unblest among tools, and people had better shun them. Therefore he who has Reason does not rely on them.
...
He conquers but rejoices not. Rejoicing at a conquest means to enjoy the slaughter of men. He who enjoys the slaughter of men will most assuredly not obtain his will in the empire.`,
  ...
  {
    chapter: 32,
    content: `Reason, in its eternal aspect, is unnamable.
...
To illustrate Reason's relation to the world we compare it to streams and creeks in their course towards rivers and the ocean.`,
  ...
  {
    chapter: 33,
    content: `One who knows others is clever, but one who knows himself is enlightened.
...
One who may die but will not perish, has life everlasting.`,
  ...
  {
    chapter: 34,
    content: `How all-pervading is the great Reason! It can be on the left and it can be on the right.
...
The holy man unto death does not make himself great and can thus accomplish his greatness.`,
  ...
  {
    chapter: 35,
    content: `"Who holdeth fast to the great Form,
...
Music with dainties makes the passing stranger stop. But Reason, when coming from the mouth, how tasteless is it! It has no flavor. When looked at, there is not enough to be seen; when listened to, there is not enough to be heard. However, when used, it is inexhaustible.`,
  ...
  {
    chapter: 36,
    content: `That which is about to contract has surely been expanded. That which is about to weaken has surely been strengthened. That which is about to fall has surely been raised. That which is about to be despoiled has surely been endowed.
...
As the fish should not escape from the deep, so with the country's sharp tools the people should not become acquainted.`,
  ...
  {
    chapter: 37,
    content: `Reason always practises non-assertion, and there is nothing that remains undone.
...
And all the world will thus be blest."`,
  ...
  {
    chapter: 38,
    content: `Superior virtue is unvirtue. Therefore it has virtue. Inferior virtue never loses sight of virtue. Therefore it has no virtue.
...
Therefore he discards the latter and chooses the former.`,
  ...
  {
    chapter: 39,
    content: `From of old these things have obtained oneness:
...
Those who have become a unity are neither anxious to be praised with praise like a gem, nor disdained with disdain like a stone.`,
  ...
  {
    chapter: 40,
    content: `"Homeward is Reason's course,
...
Heaven and earth and the ten thousand things come from existence, but existence comes from non-existence.`,
  ...
  {
    chapter: 41,
    content: `When a superior scholar hears of Reason he endeavors to practise it.
...
Reason so long as it remains latent is unnamable. Yet Reason alone is good for imparting and completing.`,
  ...
  {
    chapter: 42,
    content: `Reason begets unity; unity begets duality; duality begets trinity; and trinity begets the ten thousand things.
...
The strong and aggressive do not die a natural death; but I will obey the doctrine's father.`,
  ...
  {
    chapter: 43,
    content: `The world's weakest overcomes the world's hardest.
...
Thereby I comprehend of non-assertion the advantage. There are few in the world who obtain of non-assertion the advantage and of silence the lesson.`,
  ...
  {
    chapter: 44,
    content: `"Name or person, which is more near?
...
Forever lasteth his duration."`,
  ...
  {
    chapter: 45,
    content: `"Greatest perfection imperfect will be,
...
Motion conquers cold. Quietude conquers heat. Purity and clearness are the world's standard.`,
  ...
  {
    chapter: 46,
    content: `When the world possesses Reason, race horses are reserved for hauling dung. When the world is without Reason, war horses are bred in the common.
...
Therefore, he who knows content's content is always content.`,
  ...
  {
    chapter: 47,
    content: `"Without passing out of the gate
...
Therefore the holy man does not travel, and yet he has knowledge. He does not see things, and yet he defines them. He does not labor, and yet he completes.`,
  ...
  {
    chapter: 48,
    content: `He who seeks learnedness will daily increase. He who seeks Reason will daily diminish. He will diminish and continue to diminish until he arrives at non-assertion.
...
With non-assertion there is nothing that he cannot achieve. When he takes the empire, it is always because he uses no diplomacy. He who uses diplomacy is not fit to take the empire.`,
  ...
  {
    chapter: 49,
    content: `The holy man has not a heart of his own. The hundred families' hearts he makes his heart.
...
The holy man dwells in the world anxious, very anxious in his dealings with the world. He universalizes his heart, and the hundred families fix upon him their ears and eyes. The holy man treats them all like children.`,
  ...
  {
    chapter: 50,
    content: `Abroad in life, home in death.
...
Yea, I understand that one whose life is based on goodness, when traveling on land will not fall a prey to the rhinoceros or the tiger. When coming among soldiers, he need not fear arms and weapons. The rhinoceros finds no place wherein to insert its horn. The tiger finds no place wherein to put his claws. Weapons find no place wherein to thrust their blades. The reason is that he does not belong to the realm of death.`,
  ...
  {
    chapter: 51,
    content: `Reason quickens all creatures. Virtue feeds them. Reality shapes them. The forces complete them. Therefore among the ten thousand things there is none that does not esteem Reason and honor virtue.
...
To quicken but not to own, to make but not to claim, to raise but not to rule, this is called profound virtue.`,
  ...
  {
    chapter: 52,
    content: `When the world takes its beginning, Reason becomes the world's mother.
...
Who beholds his smallness is called enlightened. Who preserves his tenderness is called strong. Who uses Reason's light and returns home to its enlightenment does not surrender his person to perdition. This is called practising the eternal.`,
  ...
  {
    chapter: 53,
    content: `If I have ever so little knowledge, I shall walk in the great Reason. It is but expansion that I must fear.
...
Surely, this is un-Reason.`,
  ...
  {
    chapter: 54,
    content: `"What is well planted is not uprooted;
...
How do I know that the world is such? Through IT.`,
  ...
  {
    chapter: 55,
    content: `He who possesses virtue in all its solidity is like unto a little child.
...
Un-Reason soon ceases!`,
  ...
  {
    chapter: 56,
    content: `One who knows does not talk. One who talks does not know. Therefore the sage keeps his mouth shut and his sense-gates closed.
...
Thus he is inaccessible to love and also inaccessible to enmity. He is inaccessible to profit and inaccessible to loss. He is also inaccessible to favor and inaccessible to disgrace. Thus he becomes world-honored.`,
  ...
  {
    chapter: 57,
    content: `With rectitude one governs the state; with craftiness one leads the army; with non-diplomacy one takes the empire. How do I know that it is so? Through IT.
...
Therefore the holy man says: I practise non-assertion, and the people of themselves reform. I love quietude, and the people of themselves become righteous. I use no diplomacy, and the people of themselves become rich. I have no desire, and the people of themselves remain simple.`,
  ...
  {
    chapter: 58,
    content: `Whose government is unostentatious, quite unostentatious, his people will be prosperous, quite prosperous. Whose government is prying, quite prying, his people will be needy, quite needy.
...
Therefore the holy man is square but not sharp, strict but not obnoxious, upright but not restraining, bright but not dazzling.`,
  ...
  {
    chapter: 59,
    content: `To govern the people is the affair of heaven and there is nothing like thrift.
...
This is called the possession of deep roots and of a staunch stem. To life, to everlastingness, to comprehension, this is the way.`,
  ...
  {
    chapter: 60,
    content: `Govern a great country as you would fry small fish: [neither gut nor scale them.]
...
If with Reason the empire is managed, its ghosts will not spook. Not only will its ghosts not spook, but its gods will not harm the people. Not only will its gods not harm the people, but neither will its holy men harm the people. Since neither will do harm, therefore their virtues will be combined.`,
  ...
  {
    chapter: 61,
    content: `A great state, one that lowly flows, becomes the empire's union, and the empire's wife.
...
A great state desires no more than to unite and feed the people; a small state desires no more than to devote itself to the service of the people; but that both may obtain their wishes, the greater one must stoop.`,
  ...
  {
    chapter: 62,
    content: `The man of Reason is the ten thousand creatures' refuge, the good man's wealth, the bad man's stay.
...
Therefore, the holy man regards everything as difficult, and thus to the end encounters no difficulties.`,
  ...
  {
    chapter: 64,
    content: `What is still at rest is easily kept quiet. What has not as yet appeared is easily prevented. What is still feeble is easily broken. What is still scant is easily dispersed.
...
He assists the ten thousand things in their natural development, but he does not venture to interfere.`,
  ...
  {
    chapter: 65,
    content: `The ancients who were well versed in Reason did not thereby enlighten the people; they intended thereby to make them simple-hearted.
...
Spiritual virtue, verily, is profound. Verily, it is far-reaching. Verily, it is to everything reverse. But then it will procure great recognition.`,
  ...
  {
    chapter: 66,
    content: `That rivers and oceans can of the hundred valleys be kings is due to their excelling in lowliness. Thus they can of the hundred valleys be the kings.
