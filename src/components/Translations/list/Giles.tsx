export const text = [
  {
    chapter: 1,
    content: `THE Tao which can be expressed in words is not the eternal Tao; the name which can be uttered is not its eternal name. Without a name, it is the Beginning of Heaven and Earth; with a name, it is the Mother of all things. Only one who is eternally free from earthly passions can apprehend its spiritual essence; he who is ever dogged by passions can see no more than its outer form. These two things, the spiritual and the material, though we call them by different names, in their origin are one and the same. This sameness is a mystery,— the mystery of mysteries. It is the gate of all spirituality.`,
  },
  {
    chapter: 2,
    content: `AMONG mankind, the recognition of beauty as such implies the idea of ugliness, and the recognition of good implies the idea of evil.
...
`,
  ...
  {
    chapter: 3,
    content: `NOT exalting worth keeps the people from rivalry. Not prizing what is hard to procure keeps the people from theft. Not to show them what they may covet is the way to keep their minds from disorder.
Therefore the Sage, when he governs, empties their minds and fills their bellies, weakens their inclinations and strengthens their bones. His constant object is to keep the people without knowledge and without desire, or to prevent those who have knowledge from daring to act. He practises inaction, and nothing remains ungoverned.`,
  ...
  {
    chapter: 4,
    content: `How unfathomable is Tao! It seems to be the ancestral progenitor of all things. 
...
`,
  ...
  {
    chapter: 5,
    content: `Nature is not benevolent: with ruthless indifference she makes all things serve their purposes, like the straw dogs we use at sacrifices. The Sage is not benevolent: he utilises the people with the like inexorability.
The space between Heaven and Earth,—is it not like a bellows? It is empty, yet inexhaustible; when it is put in motion, more and more comes out.`,
  ...
  { chapter: 6, content: `[NONE]` },
  {
    chapter: 7,
    content: `Heaven and Earth are long-lasting. The reason why Heaven and Earth can last long is that they live not for themselves, and thus they are able to endure.
...
Is it not by neglecting self-interest that one will be able to achieve it?`,
  ...
  {
    chapter: 8,
    content: `THE highest goodness is like water, for water is excellent in benefiting all things, and it does not strive. It occupies the lowest place, which men abhor. And therefore it is near akin to Tao.
...
`,
  ...
  {
    chapter: 9,
    content: `He who grasps more than he can hold, would be better without any. 
...
When your work is done and fame has been achieved, then retire into the background; for this is the Way of Heaven.`,
  ...
  {
    chapter: 10,
    content: `He who embraces unity of soul by subordinating animal instincts to reason will be able to escape dissolution. He who strives his utmost after tenderness can become even as a little child.
...
Production without possession, action without self-assertion, development without domination: this is its mysterious operation.`,
  ...
  {
    chapter: 11,
    content: `Thirty spokes unite in one nave; the utility of the cart depends on the hollow centre in which; the axle turns. Clay is moulded into a vessel; I the utility of the vessel depends on its hollow interior. Doors and windows are cut out in order to make a house; the utility of the house depends on the empty spaces.
Thus, while the existence of things may be good, it is the non-existent in them which makes them serviceable.`,
  },
  {
    chapter: 12,
    content: `A variety of colours makes man's eye blind; a diversity of sounds makes man's ear deaf; a mixture of flavours makes man's palate dull.
...
He who respects the State as his own person is fit to govern it. He who loves the State as his own body is fit to be entrusted with it.`,
  ...
  {
    chapter: 14,
    content: `Tao eludes the sense of sight, and is therefore called colourless. It eludes the sense of hearing, and is therefore called soundless. It eludes the sense of touch, and is therefore called incorporeal. These three qualities cannot be apprehended, and hence they may be blended into unity.
...
`,
  ...
  {
    chapter: 15,
    content: `The skilful philosophers of the olden time were subtle, spiritual, profound, and penetrating. They were so deep as to be incomprehensible. Because they are hard to comprehend, I will endeavour to describe them.
...
`,
  ...
  {
    chapter: 16,
    content: `Attain complete vacuity, and sedulously preserve a state of repose.
...
How cautious is the Sage, how sparing of his words! When this task is accomplished and affairs are prosperous, the people all say: ""We have come to be as we are, naturally and of ourselves.`,
  ...
  {
    chapter: 18,
    content: `When the Great Tao falls into disuse, benevolence and righteousness come into vogue. When shrewdness and sagacity appear, great hypocrisy prevails. It is when the bonds of kinship are out of joint that filial piety and paternal affection begin. It is when the State is in a ferment of revolution that loyal patriots arise.`,
  },
  {
    chapter: 19,
    content: `Cast off your holiness, rid yourself of sagacity, and the people will benefit an hundredfold. Discard benevolence and abolish righteousness, and the people will return to filial piety and paternal love. Renounce your scheming and abandon gain, and thieves and robbers will disappear. These three precepts mean that outward show is insufficient, and therefore they bid us be true to our proper nature;—to show simplicity, to embrace plain dealing, to reduce selfishness, to moderate desire.`,
  },
  {
    chapter: 20,
    content: `Abandon learning, and you will be free from trouble and distress.
...
All men are radiant with happiness, as if enjoying a great feast, as if mounted on a tower in spring. I alone am still, and give as yet no sign of joy. I am like an infant which has not yet smiled, forlorn as one who has nowhere to lay his head. Other men have plenty, while I alone seem to have lost all. I am a man foolish in heart, dull and confused. Other men are full of light; I alone seem to be in darkness. Other men are alert; I alone am listless. I am unsettled as the ocean, drifting as though I had no stopping-place. All men have their usefulness; I alone am stupid and clownish. Lonely though I am and unlike other men, yet I revere the Foster-Mother, Tao.`,
  ...
  {
    chapter: 21,
    content: `Tao in itself is vague, impalpable,—how impalpable, how vague! Yet within it there is Form. How vague, how impalpable! Yet within it there is Substance. How profound, how obscure! Yet within it there is a Vital Principle. This principle is the Quintessence of Reality, and out of it comes Truth.
From of old until now, its name has never passed away. It watches over the beginning of all things. How do I know this about the beginning of things? Through Tao.`,
  ...
  {
    chapter: 22,
    content: `He that humbles himself shall be preserved entire. He that bends shall be made straight. He that is empty shall be filled. He that is worn out shall be renewed. He who has little shall succeed. He who has much shall go astray.
Therefore the Sage embraces Unity, and is a model for all under Heaven. He is free from self-display, therefore he shines forth; from self-assertion, therefore he is distinguished; from self-glorification, therefore he has merit; from self-exaltation, therefore he rises superior to all. Inasmuch as he does not strive, there is no one in the world who can strive with him.`,
  ...
  {
    chapter: 23,
    content: `A violent wind does not outlast the morning; a squall of rain does not outlast the day. Such is the course of Nature. And if Nature herself cannot sustain her efforts long, how much less can man!
He who acts in accordance with Tao, becomes one with Tao, He who treads the path of Virtue becomes one with Virtue. He who pursues a course of Vice becomes one with Vice. The man who is one with Tao, Tao is also glad to receive. The man who is one with Virtue, Virtue is also glad to receive. The man who is one with Vice, Vice is also glad to receive.`,
  ...
  {
    chapter: 24,
    content: `He who raises himself on tiptoe cannot stand firm; he who stretches his legs wide apart cannot walk.
...
Therefore Tao is great; Heaven is great; Earth is great; and the Sovereign also is great. In the Universe there are four powers, of which the Sovereign is one. Man takes his law from the Earth; the Earth takes its law from Heaven; Heaven takes its law from Tao; but the law of Tao is its own spontaneity.`,
  ...
  {
    chapter: 26,
    content: `The heavy is the foundation of the light; repose is the ruler of unrest.
The wise prince in his daily course never departs from gravity and repose. Though he possess a gorgeous palace, he will dwell therein with calm indifference. How should the lord of a myriad chariots conduct himself with levity in the Empire? Levity loses men's hearts; unrest loses the throne.`,
  ...
  {
    chapter: 27,
    content: `The skilful traveller leaves no tracks; the skilful speaker makes no blunders; the skilful reckoner uses no tallies. He who knows how to shut uses no bolts—yet you cannot open. He who knows bow to bind uses no cords—yet you cannot undo.
...
The good man is the bad man's teacher; the bad man is the material upon which the good man works. If the one does not value his teacher, if the other does not love his material, I then despite their sagacity they must go far I astray. This is a mystery of great import.`,
  },
  {
    chapter: 28,
    content: `He who, conscious of being strong, is content to be weak,—he shall be the paragon of mankind. Being the paragon of mankind, Virtue will never desert him. He returns to the state of a little child.
...
As unwrought material is divided up and made into serviceable vessels, so the Sage turns his simplicity to account, and thereby becomes the ruler of rulers.`,
  ...
  {
    chapter: 29,
    content: `If any one desires to take the Empire in hand and govern it, I see that he will not succeed. The Empire is a divine utensil which may not be roughly handled. He who meddles, mars. He who holds it by force, loses it.
The course of things is such that what was in front is now behind; what was hot is now cold; what was strong is now weak; what was complete is now in ruin. Therefore the Sage avoids excess, extravagance, and grandeur.`,
  ...
  {
    chapter: 30,
    content: `HE who serves a ruler of men in harmony with Tao will not subdue the Empire by force of arms. Such a course is wont to bring retribution in its train.
...
Things wax strong and then decay. This is the contrary of Tao. What is contrary to Tao soon perishes.`,
  ...
  {
    chapter: 31,
    content: `Weapons, however beautiful, are instruments of ill omen, hateful to all creatures. Therefore he who has Tao will have nothing to do with them.
...
On happy occasions, the left is favoured; on sad occasions, the right. The second in command has his place on the left, the general in chief on the right. That is to say, they are placed in the order observed at funeral rites. And, indeed, he who has exterminated a great multitude of men should bewail them with tears and lamentation. It is well that those who are victorious in battle should be placed in the order of funeral rites.`,
  ...
  {
    chapter: 32,
    content: `Tao in its unchanging aspect has no name. Small though it be in its primordial simplicity, mankind dare not claim its service. Could princes and kings hold and keep it, all creation would spontaneously pay homage. Heaven and Earth would unite in sending down sweet dew, and the people would be righteous unbidden and of their own accord.

Tao as it exists in the world is like the great rivers and seas which receive the streams from the valleys.`,
  },
  {
    chapter: 33,
    content: `He who knows others is clever, but he who knows himself is enlightened. He who overcomes others is strong, but he who overcomes himself is mightier still. 
To see oneself is to be dear of sight. Mighty is he who conquers himself.
He is rich who knows when he has enough. He who acts with energy has strength of purpose. He who moves not from his proper place is long-lasting. He who dies, but perishes not, enjoys true longevity.`,
  },
  {
    chapter: 34,
    content: `All-pervading is the Great Tao. It can be at once on the right hand and on the left. All things depend on it for life, and it rejects them not. Its task accomplished, it takes no credit. It loves and nourishes all things, but does not act as master. It is ever free from desire. We may call it small. All things return to it, yet it does not act as master. We may call it great.
The Sage never affects to do anything great, and therefore he is able to achieve his great results.`,
  },
  {
    chapter: 35,
    content: `The whole world will flock to him who holds the mighty form of Tao. They will come and receive no hurt, but find rest, peace, and tranquillity.
...
Not visible to the sight, not audible to the ear, in its use it is inexhaustible.`,
  ...
  {
    chapter: 36,
    content: `If you would contract, you must first expand. If you would weaken, you must first strengthen. If you would overthrow, you must first raise up. If you would take, you must first give. This is called the dawn of intelligence.
Fishes must not be taken from the water: the methods of government must not be exhibited to the people.`,
  },
  {
    chapter: 37,
    content: `Tao is eternally inactive, and yet it leaves nothing undone. If kings and princes could but hold fast to this principle, all things would work out their own reformation. If, having reformed, they still desired to act, I would have them restrained by the simplicity of the Nameless Tao. The simplicity of the Nameless Tao brings about an absence of desire. The absence of desire gives tranquillity. And thus the Empire will rectify itself.`,
  },
  {
    chapter: 38,
    content: `Perfect Virtue acquires nothing; therefore it obtains everything. Perfect Virtue does nothing, yet there is nothing which it does not effect. Perfect Charity operates without the need of anything to evoke it. Perfect Duty to one's neighbour operates, but always needs to be evoked. Perfect Ceremony operates, and calls for no outward response; nevertheless it induces respect.
...
Do not wish to be rare like jade, or common like stone.`,
  ...
  {
    chapter: 40,
    content: `Retrogression is the movement of Tao. Weakness is the character of Tao.
All things under Heaven derive their being from Tao in the form of Existence; Tao in the form of Existence sprang from Tao in the form of Non-Existence.`,
  ...
  {
    chapter: 41,
    content: `When the superior scholar hears of Tao, he diligently practises it. When the average scholar hears of Tao, he sometimes retains it, sometimes loses it. When the inferior scholar hears of Tao, he loudly laughs at it. Were it not thus ridiculed, it would not be worthy of the name of Tao.
...
Thus it is that ""Some things are increased by being diminished, others are diminished by being increased."" What others have taught, I also teach; verily, I will make it the root of my teaching.`,
  ...
  {
    chapter: 43,
    content: `The softest things in the world override the hardest. That which has no substance enters where there is no crevice. Hence I know the advantage of inaction.
Conveying lessons without words, reaping profit without action,—there are few in the world who can attain to this!`,
  },
  {
    chapter: 44,
    content: `Which is nearer to you, fame or life? Which is more to you, life or wealth? Which is the greater malady, gain or loss?
Excessive ambitions necessarily entail great sacrifice. Much hoarding must be followed by heavy loss. He who knows when he has enough will not be put to shame. He who knows when to stop will not come to harm. Such a man can look forward to long life.`,
  ...
  {
    chapter: 45,
    content: `He who is most perfect seems to be lacking; yet his resources are never outworn. He who is most full seems vacant; yet his uses are inexhaustible.
...
Activity conquers cold, but stillness conquers heat. Purity and stillness are the correct principles for mankind.`,
  ...
  {
    chapter: 46,
    content: `If Tao prevails on earth, horses will be used for purposes of agriculture. If Tao does not prevail, war-horses will be bred on the common.
...
There is no sin greater than ambition; no calamity greater than discontent; no vice more sickening than covetousness. He who is content always has enough.`,
  ...
  {
    chapter: 47,
    content: `Without going out of doors one may know the whole world; without looking out of the window, one may see the Way of Heaven. The further one travels, the less one may know. Thus it is that without moving you shall know; without looking you shall see; without doing you shall achieve.`,
  },
  {
    chapter: 48,
    content: `The pursuit of book-learning brings about daily increase. The practice of Tao brings about daily loss. Repeat this loss again and again, and you arrive at inaction. Practise inaction, and there is nothing which cannot be done.
The Empire has ever been won by letting things take their course. He who must always be doing is unfit to obtain the Empire.`,
  ...
  {
    chapter: 49,
    content: `To the good I would be good; to the not-good I would also be good, in order to make them good.
...
The Sage has no hard and fast ideas, but he shares the ideas of the people and makes them his own. Living in the world, he is apprehensive lest his heart be sullied by contact with the world. The people all fix their eyes and ears upon him. The Sage looks upon all as his children.`,
  ...
  {
    chapter: 52,
    content: `The World has a First Cause, which may be regarded as the Mother of the World. When one has the Mother, one can know the Child. He who knows the Child and still keeps the Mother, though his body perish, shall run no risk of harm.
...
Use the light that is in you to revert to your natural clearness of sight. Then the loss of the body is unattended by calamity. This is called doubly enduring.`,
  ...
  {
    chapter: 53,
    content: `If we had sufficient knowledge to walk in the Great Way, what we should most fear would be boastful display.
...
The wearing of gay embroidered robes, the carrying of sharp swords, fastidiousness in food and drink, superabundance of property and wealth:—this I call flaunting robbery; most assuredly it is not Tao.`,
  ...
  {
    chapter: 54,
    content: `He who knows how to plant, shall not have his plant uprooted; he who knows how to hold a thing, shall not have it taken away. Sons and grandsons will worship at his shrine, which shall endure from generation to generation.`,
  },
  {
    chapter: 55,
    content: `He who trusts to his abundance of natural virtue is like an infant newly born, whom venomous reptiles will not sting, wild beasts will not seize, birds of prey will not strike. The infant's bones are weak, its sinews are soft, yet its grasp is firm. All day long it will cry without its voice becoming hoarse. This is because the harmony of its bodily system is perfect.
...
The greater the number of laws and enactments, the more thieves and robbers there will be. Therefore the Sage says: ""So long as I do nothing, the people will work out their own reformation. So long as I love calm, the people will right themselves. If only I keep from meddling, the people will grow rich. If only I am free from desire, the people will come naturally back to simplicity.`,
  ...
  {
    chapter: 58,
    content: `If the government is sluggish and tolerant, the people will be honest and free from guile. If the government is prying and meddling, there will be constant infraction of the law. Is the government corrupt? 
...
Be square without being angular. Be honest without being mean. Be upright without being punctilious. Be brilliant without being showy.`,
  ...
  {
    chapter: 59,
    content: `In governing men and in serving Heaven, there is nothing like moderation. For only by moderation can there be an early return to man's normal state. This early return is the same as a great storage of Virtue. With a great storage of Virtue there is naught which may not be achieved. If there is naught which may not be achieved, then no one will know to what extent this power reaches. And if no one knows to what extent a man's power reaches, that man is fit to be the ruler of a State. Having the secret of rule, his rule shall endure. Setting the tap-root deep, and making the spreading roots firm: this is the way to ensure long life to the tree.`,
  },
  {
    chapter: 60,
    content: `Govern a great nation as you would cook a small fish.
If the Empire is governed according to Tao, disembodied spirits will not manifest supernatural powers. It is not that they lack supernatural power, but they will not use it to hurt mankind. Again, it is not that they are unable to hurt mankind, but they see that the Sage also does not hurt mankind. If then neither Sage nor spirits work harm, their virtue converges to one beneficent end.`,
  ...
  {
    chapter: 61,
    content: `What makes a kingdom great is its being like a down-flowing river,—the central point towards which all the smaller streams under Heaven converge; or like the female throughout the world, who by quiescence always overcomes the male. And quiescence is a form of humility.
Therefore, if a great kingdom humbles itself before a small kingdom, it shall make that small kingdom its prize. And if a small kingdom humbles itself before a great kingdom, it shall win over that great kingdom. Thus the one humbles itself in order to attain, the other attains because it is humble. If the great kingdom has no further desire than to bring men together and to nourish them, the small kingdom will have no further desire than to enter the service of the other. But in order that both may have their desire, the great one must learn humility.`,
  ...
  {
    chapter: 62,
    content: `Tao is the sanctuary where all things find refuge, the good man's priceless treasure, the guardian and saviour of him who is not good. 
...
Why was it that the men of old esteemed this Tao so highly? Is it not because it may be daily sought and found, and can remit the sins of the guilty? Hence it is the most precious thing under Heaven.`,
  ...
  {
    chapter: 63,
    content: `Practise inaction, occupy yourself with doing nothing. 
...
`,
  ...
  {
    chapter: 64,
    content: `The tree which needs two arms to span its girth sprang from the tiniest shoot. Yon tower, nine storeys high, rose from a little mound of earth. A journey of a thousand miles began with a single step.
...
Desire not to desire, and you will not value things difficult to obtain. Learn not to learn, and you will revert to a condition which mankind in general has lost.`,
  ...
  {
    chapter: 65,
    content: `In ancient times those who knew how to practise Tao did not use it to enlighten the people, but rather to keep them ignorant. The difficulty of governing the people arises from their having too much knowledge.
He who tries to govern a kingdom by his sagacity is of that kingdom the despoiler; but he who does not govern by sagacity is the kingdom's blessing. He who understands these two sayings may he regarded as a pattern and a model. To keep this principle constantly before one's eyes is called Profound Virtue. Profound Virtue is unfathomable, far-reaching, paradoxical at first, but afterwards exhibiting thorough conformity with Nature.`,
  ...
  {
    chapter: 66,
    content: `The reason why rivers and seas are able to be lords over a hundred mountain streams, is that they know how to keep below them. That is why they are able to reign over all the mountain streams.
Therefore the Sage, wishing to be above the people, must by his words put himself below them; wishing to be before the people, he must put himself behind them. In this way, though he has his place above them, the people do not feel his weight; though he has his place before them, they do not feel it as an injury. Therefore all mankind delight to exalt him, and weary of him not. The Sage expects no recognition for what he does; he achieves merit but does not take it to himself; he does not wish to display his worth.`,
  ...
  {
    chapter: 67,
    content: `All the world says that my Tao is great, but unlike other teaching. It is just because it is great that it appears unlike other teaching. If it had this likeness, long ago would its smallness have been known.
...
Gentleness brings victory to him who attacks, and safety to him who defends. Those whom Heaven would save, it fences round with gentleness.`,
  ...
  {
    chapter: 68,
    content: `The best soldiers are not warlike; the best fighters do not lose their temper. The greatest conquerors are those who overcome their enemies without strife. The greatest directors of men are those who yield place to others. This is called the Virtue of not striving, the capacity for directing mankind; this is being the compeer of Heaven. It was the highest goal of the ancients.`,
  },
  {
    chapter: 69,
...
When opposing warriors join in battle, he who has pity conquers.`,
  ...
  {
    chapter: 70,
    content: `My words are very easy to understand, very easy to put into practice; yet the world can neither understand nor practise them.
...
Thus the Sage wears coarse garments, but carries a jewel in his bosom.`,
  ...
  {
    chapter: 71,
    content: `To know, but to be as though not knowing, is the height of wisdom. Not to know, and yet to affect knowledge, is a vice. If we regard this vice as such, we shall escape it. The Sage has not this vice. It is because he regards it as a vice that he escapes it.`,
  },
  {
    chapter: 72,
    content: `If the people do not fear the majesty of government, a reign of terror will ensue. Do not confine them within too narrow bounds; do not make their lives too weary. For if you do not weary them of life, then they will not grow weary of you.
The Sage knows what is in him, but makes no display; he respects himself, but seeks not honour for himself.`,
  },
  {
    chapter: 73,
    content: `He whose boldness leads him to venture, will be slain; he who is brave enough not to venture, will live. Of these two, one has the benefit, the other has the hurt. But who is it that knows the real cause of Heaven's hatred? This is why the Sage hesitates and finds it difficult to act. The violent and stiff-necked die not by a natural death.
...
Heaven's net is vast; though its meshes are wide, it lets nothing slip through.`,
  ...
  {
    chapter: 74,
    content: `If the people do not fear death, what good is there in using death as a deterrent? But if the people are brought up in fear of death, and we can take and execute any man who has committed a monstrous crime, who will dare to follow his example?
Now, there is always one who presides over the infliction of death. He who would take the place of the magistrate and himself inflict death, is like one who should try to do the work of a master-carpenter. And of those who try the work of a master-carpenter there are few who do not cut their own hands.`,
  ...
  {
    chapter: 75,
    content: `The people starve because those in authority over them devour too many taxes; that is why they starve. The people are difficult to govern because those placed over them are meddlesome; that is why they are difficult to govern. The people despise death because of their excessive labour in seeking the means of life; that is why they despise death.
Only he who does nothing for his life's sake can truly be said to value his life.`,
  },
  {
    chapter: 76,
    content: `Man at his birth is tender and weak; at his death he is rigid and strong. Plants and trees when they come forth are tender and crisp; when dead, they are dry and tough. Thus rigidity and strength are the concomitants of death; softness and weakness are the concomitants of life.
Hence the warrior that is strong does not conquer; the tree that is strong is cut down. Therefore the strong and the big take the lower place; the soft and the weak take the higher place.`,
  ...
  {
    chapter: 77,
    content: `The Way of Heaven is like the drawing of a bow: it brings down what is high and raises what is low.
