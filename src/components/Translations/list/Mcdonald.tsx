export const text = [
  {
    chapter: 1,
    content: `The tao that can be described
...
The beginning of all understanding.`,
  ...
  {
    chapter: 2,
    content: `When people see things as beautiful,
ugliness is created.
...
That is why it will last forever.`,
  ...
  {
    chapter: 3,
    content: `If you overly esteem talented individuals,
...
everything will fall into place.`,
  ...
  {
    chapter: 4,
    content: `The Tao is like an empty container:
...
It is better not to speak of things you do not understand.`,
  ...
  {
    chapter: 6,
    content: `The spirit of emptiness is immortal.
...
Use it effortlessly.`,
  ...
  {
    chapter: 7,
    content: `The Tao of Heaven is eternal,
...
will we all live in peace.`,
  ...
  {
    chapter: 9,
    content: `It is easier to carry an empty cup
...
This is the pathway to Heaven.`,
  ...
  {
    chapter: 10,
    content: `Nurture the darkness of your soul
...
This is the mysterious virtue.`,
  ...
  {
    chapter: 11,
    content: `Thirty spokes are joined together in a wheel,
...
but the emptiness is what we use.`,
  ...
  {
    chapter: 12,
    content: `Five colors blind the eye.
...
She shuns the latter, and prefers to seek the former.`,
  ...
  {
    chapter: 13,
    content: `Success is as dangerous as failure,
...
then you will truly care for all things.`,
  ...
  {
    chapter: 14,
    content: `Look for it, and it can't be seen.
...
this is the beginning of wisdom.`,
  ...
  {
    chapter: 15,
    content: `The Sages of old were profound
...
which brings the feeling of completeness.`,
  ...
  {
    chapter: 16,
    content: `If you can empty your mind of all thoughts
...
and we are one with Tao.`,
  ...
  {
    chapter: 17,
    content: `The best leaders are those the people hardly know exist.
...
politicians talk about 'patriotism'.`,
  ...
  {
    chapter: 19,
    content: `Forget about knowledge and wisdom,
...
Desire little.`,
  ...
  {
    chapter: 20,
    content: `Renounce knowledge and your problems will end.
...
I nurse from the Great Mother's breasts.`,
  ...
  {
    chapter: 21,
    content: `The greatest virtue you can have
...
I look inside myself and see it.`,
  ...
  {
    chapter: 22,
    content: `If you want to become whole,
...
people will become untrustworthy.""`,
  ...
  {
    chapter: 24,
    content: `Those who stand on tiptoes
do not stand firmly.
...
we must not do these things.`,
  ...
  {
    chapter: 25,
    content: `Before the universe was born
...
The Tao follows only itself.`,
  ...
  {
    chapter: 26,
    content: `Heaviness is the basis of lightness.
...
you will lose the basis of your power.`,
  ...
  {
    chapter: 27,
    content: `A good traveler leaves no tracks,
...
Great works do not involve discarding substance.`,
  ...
  {
    chapter: 29,
    content: `Do you want to rule the world and control it?
...
, excess and the extremes.`,
  ...
  {
    chapter: 30,
    content: `Those who lead people by following the Tao
...
That which is not of the Tao will soon end.`,
  ...
  {
    chapter: 31,
    content: `Weapons are the bearers of bad news;
...
and the victory celebration should honor those who have died.`,
  ...
  {
    chapter: 32,
    content: `The Tao is nameless and unchanging.
...
flow through valleys to the sea.`,
  ...
  {
    chapter: 33,
    content: `Those who know others are intelligent;
...
but have life everlasting.`,
  ...
  {
    chapter: 34,
    content: `The great Tao flows unobstructed in every direction.
...
it is able to accomplish truly great things.`,
  ...
  {
    chapter: 35,
    content: `She who follows the way of the Tao
...
Yet if they put it to use, it would never be exhausted.`,
  ...
  {
    chapter: 36,
    content: `If you want something to return to the source,
...
it is best to keep weapons out of sight.`,
  ...
  {
    chapter: 37,
    content: `The Tao never acts with force,
...
the world would naturally settle into peace.`,
  ...
  {
    chapter: 38,
    content: `The highest good is not to seek to do good,
...
This is how she increases in wisdom.`,
  ...
  {
    chapter: 39,
    content: `The masters of old attained unity with the Tao.
...
but be as dull as a common stone.`,
  ...
  {
    chapter: 40,
    content: `All movement returns to the Tao.
...
Substance is born of nothing-ness.`,
  ...
  {
    chapter: 41,
    content: `When a superior person hears of the Tao,
...
Yet it alone nourishes and completes all things.`,
  ...
  {
    chapter: 42,
    content: `The Tao gave birth to One.
...
""The strong and violent will not die a natural death.""`,
  ...
  {
    chapter: 43,
    content: `That which offers no resistance,
...
or understand the value of non-action.`,
  ...
  {
    chapter: 44,
    content: `Which is more important, your honor or your life?
...
and bring you a long, happy life.`,
  ...
  {
    chapter: 45,
    content: `The greatest accomplishments seem imperfect,
...
That which is pure and still is the universal ideal.`,
  ...
  {
    chapter: 46,
    content: `When the world follows the Tao,
...
Whoever knows contentment will be at peace forever.`,
  ...
  {
    chapter: 47,
    content: `Without opening your door,
...
accomplishes much without doing anything.`,
  ...
  {
    chapter: 48,
    content: `One who seeks knowledge learns something new every day.
...
You cannot master the world by changing the natural way.`,
  ...
  {
    chapter: 49,
    content: `The Master has no mind of her own.
...
Yet she treats them all as her children.`,
  ...
  {
    chapter: 50,
    content: `Those who leave the womb at birth
...
Why? Because they can find no place for death in them.`,
  ...
  {
    chapter: 51,
    content: `The Tao gives birth to all of creation.
...
is called depending on the Constant.`,
  ...
  {
    chapter: 53,
    content: `If I understood only one thing,
...
Oh, how these things go against the way of the Tao!`,
  ...
  {
    chapter: 54,
    content: `That which is well built
...
I observe these things and see.`,
  ...
  {
    chapter: 55,
    content: `One who is filled with the Tao
...
Those who do it will come to an early end.`,
  ...
  {
    chapter: 56,
    content: `Those who know do not talk.
...
This makes them the most noble of all under the heavens.`,
  ...
  {
    chapter: 57,
    content: `Govern your country with integrity,
...
and the people return to the Uncarved Block.`,
  ...
  {
    chapter: 58,
    content: `If a government is unobtrusive,
...
Radiant, and easy on the eye.`,
  ...
  {
    chapter: 59,
    content: `There is nothing better than moderation
...
the Way to a long life and great spiritual vision.`,
  ...
  {
    chapter: 60,
    content: `Governing a large country
...
then virtue will return by itself.`,
  ...
  {
    chapter: 61,
    content: `A large country should take the low place like a great watershed,
...
Both large and small countries benefit greatly from humility.`,
  ...
  {
    chapter: 62,
    content: `The Tao is the tabernacle of creation;
...
so the task is always easier than planned.`,
  ...
  {
    chapter: 64,
    content: `Things are easier to control while things are quiet.
...
but leads to harmony with the heavens.`,
  ...
  {
    chapter: 66,
    content: `Rivers and seas are rulers
...
no one can compete with the things she accomplishes.`,
  ...
  {
    chapter: 67,
    content: `The world talks about honoring the Tao,
...
that enters with the greatest sorrow.`,
  ...
  {
    chapter: 70,
    content: `My words are easy to understand
...
my teachings become even more precious.`,
  ...
  {
    chapter: 71,
    content: `Knowing you don't know is wholeness.
...
and thus is able to remain whole.`,
  ...
  {
    chapter: 72,
    content: `When people become overly bold,
...
This is how she is able to make appropriate choices.`,
  ...
  {
    chapter: 73,
    content: `Being over bold and confidant is deadly.
...
but nothing escapes its grasp.`,
  ...
  {
    chapter: 74,
    content: `If you do not fear death,
...
Only those who do not cling to their life can save it.`,
  ...
  {
    chapter: 76,
    content: `The living are soft and yielding;
...
The soft and yielding will overcome.`,
  ...
  {
    chapter: 77,
    content: `The Tao of Heaven works in the world
...
and does not glory in any praise.`,
  ...
  {
    chapter: 78,
    content: `Water is the softest and most yielding substance.
...
True sayings seem contradictory.`,
  ...
  {
    chapter: 79,
    content: `Difficulties remain, even after solving a problem.
...
because she is on its side.`,
  ...
  {
    chapter: 80,
    content: `Small countries with few people are best.
...
all of the days of their life.`,
  ...
  {
    chapter: 81,
    content: `True words do not sound beautiful;
