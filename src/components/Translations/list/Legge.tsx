export const text = [
  {
    chapter: 1,
    content: `The Tao that can be trodden is not the enduring and
...
is subtle and wonderful.`,
  ...
  {
    chapter: 2,
    content: `All in the world know the beauty of the beautiful, and in doing
...
'Tis this that makes the power not cease to be.`,
  ...
  {
    chapter: 3,
    content: `Not to value and employ men of superior ability is the way to
...
action, good order is universal.`,
  ...
  {
    chapter: 4,
    content: `The Tao is (like) the emptiness of a vessel; and in our
...
God.`,
  ...
  {
    chapter: 5,
    content: `Heaven and earth do not act from (the impulse of) any wish to be
...
Your inner being guard, and keep it free.`,
  ...
  {
    chapter: 6,
    content: `The valley spirit dies not, aye the same;
...
Used gently, and without the touch of pain.`,
  ...
  {
    chapter: 7,
    content: `Heaven is long-enduring and earth continues long. The reason
...
personal and private ends, that therefore such ends are realised?`,
  ...
  {
    chapter: 8,
    content: `The highest excellence is like (that of) water. The excellence
...
his low position), no one finds fault with him.`,
  ...
  {
    chapter: 9,
    content: `It is better to leave a vessel unfilled, than to attempt to
...
distinguished, to withdraw into obscurity is the way of Heaven.`,
  ...
  {
    chapter: 10,
    content: `When the intelligent and animal souls are held together in one
...
This is what is called 'The mysterious Quality' (of the Tao).`,
  ...
  {
    chapter: 11,
    content: `The thirty spokes unite in the one nave; but it is on the empty
...
profitable adaptation, and what has not that for (actual) usefulness.`,
  ...
  {
    chapter: 12,
    content: `Colour's five hues from th' eyes their sight will take;
...
latter, and prefers to seek the former.`,
  ...
  {
    chapter: 13,
    content: `Favour and disgrace would seem equally to be feared; honour and
...
entrusted with it.`,
  ...
  {
    chapter: 14,
    content: `We look at it, and we do not see it, and we name it 'the
...
beginning, this is called (unwinding) the clue of Tao.`,
  ...
  {
    chapter: 15,
    content: `The skilful masters (of the Tao) in old times, with a subtle
...
they can afford to seem worn and not appear new and complete.`,
  ...
  {
    chapter: 16,
    content: `The (state of) vacancy should be brought to the utmost degree,
...
and to the end of his bodily life, is exempt from all danger of decay.`,
  ...
  {
    chapter: 17,
    content: `In the highest antiquity, (the people) did not know that there
...
people all said, 'We are as we are, of ourselves!'`,
  ...
  {
    chapter: 18,
    content: `When the Great Tao (Way or Method) ceased to be observed,
...
into disorder, loyal ministers appeared.`,
  ...
  {
    chapter: 19,
    content: `If we could renounce our sageness and discard our wisdom, it
...
Would selfish ends and many lusts eschew.`,
  ...
  {
    chapter: 20,
    content: `When we renounce learning we have no troubles.
...
am different from other men, but I value the nursing-mother (the Tao).`,
  ...
  {
    chapter: 21,
    content: `The grandest forms of active force
...
this (nature of the Tao).`,
  ...
  {
    chapter: 22,
    content: `The partial becomes complete; the crooked, straight; the empty,
...
not vainly spoken:--all real completion is comprehended under it.`,
  ...
  {
    chapter: 23,
    content: `Abstaining from speech marks him who is obeying the spontaneity
...
faith (in him) ensues (on the part of the others).`,
  ...
  {
    chapter: 24,
    content: `He who stands on his tiptoes does not stand firm; he who stretches
...
of the Tao do not adopt and allow them.`,
  ...
  {
    chapter: 25,
    content: `There was something undefined and complete, coming into
...
being what it is.`,
  ...
  {
    chapter: 26,
    content: `Gravity is the root of lightness; stillness, the ruler of
movement.
...
gravity); if he proceed to active movement, he will lose his throne.`,
  ...
  {
    chapter: 27,
    content: `The skilful traveller leaves no traces of his wheels or
...
called 'The utmost degree of mystery.'`,
  ...
  {
    chapter: 28,
    content: `Who knows his manhood's strength,
...
no violent measures.`,
  ...
  {
    chapter: 29,
    content: `If any one should wish to get the kingdom for himself, and to
...
indulgence.`,
  ...
  {
    chapter: 30,
    content: `He who would assist a lord of men in harmony with the Tao will
...
in accordance with it soon comes to an end.`,
  ...
  {
    chapter: 31,
    content: `Now arms, however beautiful, are instruments of evil omen,
...
battle has his place (rightly) according to those rites.`,
  ...
  {
    chapter: 32,
    content: `The Tao, considered as unchanging, has no name.
...
rivers and seas to the streams from the valleys.`,
  ...
  {
    chapter: 33,
    content: `He who knows other men is discerning; he who knows himself is
...
long; he who dies and yet does not perish, has longevity.`,
  ...
  {
    chapter: 34,
    content: `All-pervading is the Great Tao! It may be found on the left
...
accomplish them.`,
  ...
  {
    chapter: 35,
    content: `To him who holds in his hands the Great Image (of the invisible
...
the use of it is inexhaustible.`,
  ...
  {
    chapter: 36,
    content: `When one is about to take an inspiration, he is sure to make a
...
profit of a state should not be shown to the people.`,
  ...
  {
    chapter: 37,
    content: `The Tao in its regular course does nothing (for the sake of
...
All things go right as of their will.`,
  ...
  {
    chapter: 38,
    content: `(Those who) possessed in highest degree the attributes (of the
...
thus that he puts away the one and makes choice of the other.`,
  ...
  {
    chapter: 39,
    content: `The things which from of old have got the One (the Tao) are--
...
(ordinary) stone.`,
  ...
  {
    chapter: 40,
    content: `The movement of the Tao
...
that existence sprang from It as non-existent (and not named).`,
  ...
  {
    chapter: 41,
    content: `Scholars of the highest class, when they hear about the Tao,
...
complete.`,
  ...
  {
    chapter: 42,
    content: `The Tao produced One; One produced Two; Two produced Three;
...
teaching.`,
  ...
  {
    chapter: 43,
    content: `The softest thing in the world dashes against and overcomes the
...
Long live shall he.`,
  ...
  {
    chapter: 45,
    content: `Who thinks his great achievements poor
...
and stillness give the correct law to all under heaven.`,
  ...
  {
    chapter: 46,
    content: `When the Tao prevails in the world, they send back their swift
...
an enduring and unchanging sufficiency.`,
  ...
  {
    chapter: 47,
    content: `Without going outside his door, one understands (all that takes
...
their ends without any purpose of doing so.`,
  ...
  {
    chapter: 48,
    content: `He who devotes himself to learning (seeks) from day to day to
...
is not equal to getting as his own all under heaven.`,
  ...
  {
    chapter: 49,
    content: `The sage has no invariable mind of his own; he makes the mind
...
children.`,
  ...
  {
    chapter: 50,
    content: `Men come forth and live; they enter (again) and die.
...
Because there is in him no place of death.`,
  ...
  {
    chapter: 51,
    content: `All things are produced by the Tao, and nourished by its
...
them;--this is called its mysterious operation.`,
  ...
  {
    chapter: 52,
    content: `(The Tao) which originated all under the sky is to be
...
And hides the unchanging from men's sight.`,
  ...
  {
    chapter: 53,
    content: `If I were suddenly to become known, and (put into a position
...
robbers and boasters. This is contrary to the Tao surely!`,
  ...
  {
    chapter: 54,
    content: `What (Tao's) skilful planter plants
Can never be uptorn;
...
sky? By this (method of observation).`,
  ...
  {
    chapter: 55,
    content: `He who has in himself abundantly the attributes (of the Tao) is
...
soon ends.`,
  ...
  {
    chapter: 56,
    content: `He who knows (the Tao) does not (care to) speak (about it); he
...
meanness:--he is the noblest man under heaven.`,
  ...
  {
    chapter: 57,
    content: `A state may be ruled by (measures of) correction; weapons of
...
the primitive simplicity.'`,
  ...
  {
    chapter: 58,
    content: `The government that seems the most unwise,
...
but does not dazzle.`,
  ...
  {
    chapter: 59,
    content: `For regulating the human (in our constitution) and rendering
...
enduring life shall long be seen.`,
  ...
  {
    chapter: 60,
    content: `Governing a great state is like cooking small fish.
...
influences converge in the virtue (of the Tao).`,
  ...
  {
    chapter: 61,
    content: `What makes a great state is its being (like) a low-lying, down-
...
itself.`,
  ...
  {
    chapter: 62,
    content: `Tao has of all things the most honoured place.
...
under heaven consider it the most valuable thing.`,
  ...
  {
    chapter: 63,
    content: `(It is the way of the Tao) to act without (thinking of) acting;
...
never has any difficulties.`,
  ...
  {
    chapter: 64,
    content: `That which is at rest is easily kept hold of; before a thing
...
to act (with an ulterior purpose of his own).`,
  ...
  {
    chapter: 65,
    content: `The ancients who showed their skill in practising the Tao did
...
to others, but leading them to a great conformity to him.`,
  ...
  {
    chapter: 66,
    content: `That whereby the rivers and seas are able to receive the homage
...
with him.`,
  ...
  {
    chapter: 67,
    content: `All the world says that, while my Tao is great, it yet appears
...
gentleness protecting him.`,
  ...
  {
    chapter: 68,
    content: `He who in (Tao's) wars has skill
...
No sage of old more bright.'`,
  ...
  {
    chapter: 69,
    content: `A master of the art of war has said, 'I do not dare to be the
...
(the situation) conquers.`,
  ...
  {
    chapter: 70,
    content: `My words are very easy to know, and very easy to practise; but
...
while he carries his (signet of) jade in his bosom.`,
  ...
  {
    chapter: 71,
    content: `To know and yet (think) we do not know is the highest
...
does not have it.`,
  ...
  {
    chapter: 72,
    content: `When the people do not fear what they ought to fear, that which
...
choice of the former.`,
  ...
  {
    chapter: 73,
    content: `He whose boldness appears in his daring (to do wrong, in
...
nothing escape.`,
  ...
  {
    chapter: 74,
    content: `The people do not fear death; to what purpose is it to (try to)
...
does not cut his own hands!`,
  ...
  {
    chapter: 75,
    content: `The people suffer from famine because of the multitude of taxes
...
it.`,
  ...
  {
    chapter: 76,
    content: `Man at his birth is supple and weak; at his death, firm and
...
of what is soft and weak is above.`,
  ...
  {
    chapter: 77,
    content: `May not the Way (or Tao) of Heaven be compared to the (method
...
does not wish to display his superiority.`,
  ...
  {
    chapter: 78,
    content: `There is nothing in the world more soft and weak than water,
...
Words that are strictly true seem to be paradoxical.`,
  ...
  {
    chapter: 79,
    content: `When a reconciliation is effected (between two parties) after a
...
on the side of the good man.`,
  ...
  {
    chapter: 80,
    content: `In a little state with a small population, I would so order it,
...
intercourse with it.`,
  ...
  {
    chapter: 81,
    content: `Sincere words are not fine; fine words are not sincere. Those
