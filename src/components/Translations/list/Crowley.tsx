export const text = [
  {
    chapter: 1,
    content: `The Tao-Path is not the All-Tao. The Name is not the Thing named.
...
The Tao is one, and the Teh but a phase thereof. The abyss of this Mystery is the Portal of Serpent-Wonder.
  ...
  {
    chapter: 2,
    content: `All men know that beauty and ugliness are correlatives, as are skill and clumsiness; one implies and suggests the other.
...
All things arise without diffidence; they grow, and none interferes; they change according to their natural order, without lust of result. The work is accomplished; yet continueth in its orbit, without goal. This work is done unconsciously; this is  why its energy is indefatigable.`,
  ...
  {
    chapter: 3,
    content: `To reward merit is to stir up emulation; to prize rarities is to encourage robbery; to display desirable things is to excite the disorder of covetousness.
...
He delivereth them from the restlessness of knowledge and the cravings of discontent. As to those who have knowledge already, he teacheth them the way of non-action. This being assured, there is no disorder in the world. `,
  ...
  {
    chapter: 4,
    content: `The Tao resembleth the emptiness of Space; to employ it, we must avoid creating ganglia. Oh Tao, how vast art Thou, the Abyss of Abysses, thou Holy and Secret Father of all Fatherhoods of Things!
...
This Tao hath no Father; it is beyond all other conceptions, higher than the highest. `,
  ...
  {
    chapter: 5,
    content: `Heaven and earth proceed without motive, but casually in their order of nature, dealing with all things carelessly, like used talismans. So also the sages deal with their people, not exercising benevolence, but allowing the nature of all to move without friction.
The Space between heaven and earth is their breathing apparatus: Exhalation is not exhaustion, but the complement of Inhalation, and this equally of that. Speech exhausteth; guard thyself, therefore, maintaining the perfect freedom of thy nature. `,
  ...
  {
    chapter: 6,
    content: `The Teh is the immortal enemy of the Tao, its feminine aspect. Heaven and Earth issued from her Gate; this Gate is the Root of their World-Sycamore. Its operation is of pure Joy and Love, and faileth never.`,
  },
  {
    chapter: 7,
    content: `Heaven and Earth are mighty in continuance, because their work is delivered from the lust of result.
Thus also the sage, seeking not any goal, attaineth all things; he doth not interfere in the affairs of his body, and so that body acteth without friction. It is because he meddleth not with personal aims that these come to pass with simplicity. `,
  ...
  {
    chapter: 8,
    content: `Admire thou the High Way of Water! Is not Water the soul of the life of things, whereby they change? Yet it seeketh its level, and abideth content in obscurity. So also it resembleth the Tao, in this Way thereof!
...
Also it is the virtue of a man to abide in his place without discontent; thus offendeth he no man. `,
  },
  {
    chapter: 9,
    content: `Fill not a vessel, lest it spill in carrying. Meddle not with a sharpened point by feeling it constantly, or it will soon become blunted.
Gold and jade endanger the house of their possessor. Wealth and honors lead to arrogance and envy, and bring ruin. Is thy way famous and thy name becoming distinguished? Withdraw, thy work once done, into obscurity; this is the way of Heaven. `,
  ...
  {
    chapter: 10,
    content: `When soul and body are in the bond of love, they can be kept together. By concentration on the breath it is brought to perfect elasticity, and one becomes as a babe. By purifying oneself from Samadhi one becomes whole.
...
Here is the Mystery of Virtue. It createth all and nourisheth all; yet it doth not adhere to them; it operateth all, but knoweth not of it, nor proclaimeth it; it directeth all, but without conscious control. `,
  ...
  {
    chapter: 11,
    content: `The thirty spokes join in their nave, that is one; yet the wheel dependeth for use upon the hollow place for the axle. Clay is shapen to make vessels; but the contained space is what is useful. Matter is therefore of use only to mark the limits of the space which is the thing of real value.`,
  },
  {
    chapter: 12,
    content: `The five colors film over Sight; The five sounds make Hearing dull; The five flavours conceal Taste; occupation with motion and action bedevil Mind; even so the esteem of rare things begetteth covetousness and disorder.
The wise man seeketh therefore to content the actual needs of the people; not to excite them by the sight of luxuries. He banneth these, and concentrateth on those. `,
  },
  {
    chapter: 13,
    content: `Favor and disgrace are equally to be shunned; honour and calamity to be alike regarded as adhering to the personality.
...
Therefore let him that regardeth himself rightly administer also a kingdom; and let him govern it who loveth it as another man loveth himself. `,
  },
  {
    chapter: 14,
    content: `We look at it, and see it not; though it is Omnipresent; and we name it the Root-Balance.
...
We confront it, and see not its Face;  we pursue it, and its Back is hidden from us. Ah! but apply the Tao as in old Time to the work of the present; know it as it was known in the Beginning; follow fervently the Thread of the Tao. `,
  ...
  {
    chapter: 15,
    content: `The adepts of past ages were subtle and keen to apprehend this Mystery, and their profundity was obscurity unto men. Since then they were not known, let me declare their nature.
...
The adepts of the Tao, conserving its way, seek not to be actively self-conscious. By their emptiness of Self  they have no need to show their youth and perfection; to appear old and imperfect is their privilege. `,
  },
  {
    chapter: 16,
    content: `Emptiness must be perfect, and Silence made absolute with tireless strength. All things pass through the period of action; then they return to repose. They grow, bud, blossom and fruit; then they return to the root. This return to the root is this state which we name Silence; and this Silence is Witness of their Fulfilment.
This cycle is the universal law. To know it is the part of intelligence; to ignore it bringeth folly of action, whereof the end is madness. To know it bringeth understanding and peace; and these lead to the identification of the Self with the Not-Self. This identification maketh man a king; and this kingliness groweth unto godhood. That godhood beareth fruit in the mastery of the Tao. Then the man, the Tao permeating him, endureth; and his bodily principles are in harmony,  proof against decay, until the hour of his Change. `,
  ...
  {
    chapter: 17,
    content: `In the Age of Gold, the people were not conscious of their rulers; in the Age of Silver, they loved them, with songs; in the Age of Brass, they feared them; in the Age of Iron, they despised them. As the rulers lost confidence, so also did the people lose confidence in them.
How hesitating did they seem, the Lords of the Age of Gold, speaking with deliberation, aware of the weight of their word! Thus they accomplished all things with success; and the people deemed their well-being to be the natural course of events. `,
  },
  {
    chapter: 18,
    content: `When men abandoned the Way of the Tao, benevolence and justice became necessary. Then also was need of wisdom and cunning, and all fell into illusion. When harmony ceased to prevail in the six spheres it was needful to govern them by manifesting Sons.
When the kingdoms and races became confused, loyal ministers had to appear. `,
  },
  {
    chapter: 19,
    content: `If we forgot our statesmanship and our wisdom, it would be an hundred times better for the people. If we forgot our benevolence and our justice, they would become again like sons, folk of good will. If we forget our machines and our business, there would be no knavery.
These new methods despised the olden Way, inventing fine names to disguise their baneness. But simplicity in the doing of the will of every man would put an end to vain ambitions and desires. `,
  },
  {
    chapter: 20,
...
So then his brothers in the Tao are joyful, attaining it; and his brothers in the Teh are joyful, attaining it; and they who fail in seeking these are joyful, partaking of it. But if he himself realize not the Tao with calm of confidence, then they also appear lacking in confidence. `,
  },
  {
    chapter: 24,
    content: `He who standeth a-tiptoe standeth not firm; he who maketh rigid his legs walketh ill. He who preeneth himself shineth not; he who talketh positively is vulgar; he who boastheth is refused acceptance; he who is wise in his own conceit is thought inferior. Such attitudes, to him that hath the view given by understanding the Tao, seem like garbage or like cancer, abhorrent to all. They then who follow the Way do not admit them.`,
  },
  {
    chapter: 25,
    content: `Without Limit and Perfect, there is a Becoming, beyond Heaven and Earth. It hath nor motion nor Form; it is alone, it changeth not; it extendeth all ways; it hath no Adversary. It is like the All-Mother.
...
Man followeth the formula of Earth; Earth followeth that of Heaven, and Heaven that of the Tao. The formula of the Tao is its own Nature. `,
  },
  {
    chapter: 26,
    content: `Mass is the fulcrum of mobility; stillness is the father of motion.
Therefore the sage King, though he travel afar, remaineth near his supplies. Though opportunity tempt him, he remaineth quietly in proper disposition, indifferent. Should the master of an host of chariots bear himself frivolously? If he attack without support, he loseth his base; if he become a raider, he forfeiteth his throne. `,
  ...
  {
    chapter: 27,
    content: `The experienced traveler concealeth his tracks; the clever speaker giveth no chance to the critic; the skilled mathematician useth no abacus; the ingenious safesmith baffleth the burglar without the use of bolts, and the cunning binder without ropes and knots. So also the sage, skilled in man-emancipation-craft, useth all men; understanding the value of everything, he rejecteth nothing. This is called the Occult Regimen.
The adept is then master to the zelator, and the zelator assisteth and honoreth the adept. Yet unless these relations were manifest, even the most intelligent observer might be perplexed as to which was which. This is called the Crown of Mystery. `,
  },
  {
    chapter: 28,
    content: `Balance thy male strength with thy female weakness and thou shalt attract all things, as the ocean absorbeth all rivers; for thou shalt formulate the excellence of the Child eternal, simple, and perfect.
...
The raw material, wrought into form, produceth vessels. So the sage King formulateth his Wholeness in divers Offices; and his Law is without violence or constraint. `,
  ...
  {
    chapter: 29,
    content: `He that, desiring a kingdom, exerteth himself to obtain it, will fail. A Kingdom is of the nature of spirit, and yieldeth not to activity. He who graspeth it, destroyeth it; he who gaineth it, loseth it.
The wheel of nature revolveth constantly; the last becometh first, and the first last; hot things grow cold, and cold things hot; weakness overcometh strength; things gained are lost anon. Hence the wise man avoideth effort, desire and sloth. `,
  ...
  {
    chapter: 30,
    content: `If a king summon to his aid a Master of the Tao, let Him not advise recourse to arms. Such action certainly bringeth the corresponding reaction.
...
Things become strong and ripe, then age. This is discord with the Tao; and what is not at one with the Tao soon cometh to an end. `,
  ...
  {
    chapter: 31,
    content: `Arms, though they be beautiful, are of ill omen, abominable to all created beings. They who have the Tao love not their use.
...
At feasts, the left hand is the high seat; at funerals, the right. The second in command of the army leadeth the left wing, the commander-in-chief, the right wing; it is as if the battle were a rite of mourning! He that hath slain most men should weep for them most bitterly; so then the place of the victor is assigned to him with philosophical propriety. `,
  ...
  {
    chapter: 32,
    content: `The All-Tao hath no name.
...
As the great rivers and the oceans are to the valley streams, so is the Tao to the whole universe. `,
  ...
  {
    chapter: 33,
    content: `He who understandeth others understandeth Two; but he who understandeth himself understandeth One. He who conquereth others is strong; but he who conquereth himself is stronger yet.
...
He that adapteth himself perfectly to his environment, continueth for long; he who dieth without dying, liveth for ever. `,
  ...
  {
    chapter: 34,
    content: `The Tao is immanent; it extendeth to the right hand as to the left.
...
In this manner also may the Sage perform his Works. It is by not thrusting himself forward that he winneth to his success. `,
  },
  {
    chapter: 35,
    content: `The whole world is drawn to him that hath the likeness of the Tao. Men flock unto him, and suffer no ill, but gain repose, find peace, enjoy all ease.
Sweet sounds and cates lure the traveler from his way. But the Word of the Tao; though it appear harsh and insipid, unworthy to hearken or to behold; hath his use all inexhaustible. `,
  },
  {
    chapter: 36,
    content: `In order to draw breath, first empty the lungs; to weaken another, first strengthen him; to overthrow another, first exalt him; to despoil another, first load him with gifts; this is called the Occult Regimen.
The soft conquereth the hard; the weak pulleth down the strong.
The fish that leaveth ocean is lost; the method of government must be concealed from the people. `,
  },
  {
    chapter: 37,
    content: `The Tao proceedeth by its own nature, doing nothing; therefore there is no doing which it comprehendeth not.
If kings and princes were to govern in this manner, all things would operate aright by their own motion.
If this transmutation were my object, I should call it Simplicity. Simplicity hath no name nor purpose; silently and at ease all things go well. `,
  },
  {
    chapter: 38,
    content: `Those who possessed perfectly the powers did not manifest them, and so they preserved them. Those who possessed them imperfectly feared to lose them, and so lost them.
...
So then the Tao-Man holdeth to Mass, and avoideth Motion; he is attached to the Root, not to the flower. He leaveth the one, and cleaveth to the other. `,
  },
  {
    chapter: 39,
...
The root of grandeur is humility, and the strength of exaltation in its base. Thus rulers speak of themselves as "Fatherless," "Virtueless,' "Unworthy," proclaiming by this that their Glory is in their shame. So also the virtue of a Chariot is not any of the parts of a Chariot, if they be numbered. They do not seek to appear fine like jade, but inconspicuous like common stone. `,
  ...
  {
    chapter: 40,
    content: `The Tao proceeds by correlative curves, and its might is in weakness.
All things arose from the Teh, and the Teh budded from the Tao. `,
  },
  {
    chapter: 41,
    content: `The best students, learning of the Tao, set to work earnestly to practice the Way. Mediocre students now cherish it, now let it go.
...
Nameless and imperceptible is the Tao; but it informeth and perfecteth all things. `,
  },
  {
    chapter: 42,
    content: `The Tao formulated the One.
...
Others have taught thus; I consent to it. Violent men and strong die not by natural death. This fact is the foundation of my law. `,
  },
  {
    chapter: 43,
    content: `The softest substance hunteth down the hardest; the unsubstantial penetrateth where there is no opening. Here is the Virtue of Inertia.
Few are they who attain: whose speech is Silence, whose Work is Inertia. `,
  },
  {
    chapter: 44,
    content: `What shall it profit a man if he gain fame or wealth, and lose his life?
If a man cling to fame or wealth, he risketh what is worth more.
Be content, not fearing disgrace. Act not, and risk not criticism. Thus live thou long, without alarm. `,
  },
  {
    chapter: 45,
    content: `Despise thy masterpieces; thus renew the vigor of thy creation.
...
Exercise moderateth cold; stillness heat. To be pure and to keep silence, is the True Law of all that are beneath Heaven. `,
  ...
  {
    chapter: 46,
    content: `When the Tao beareth away on Earth, men put swift horses to night-carts. When it is neglected, they breed chargers in the border marches.
There is no evil worse than ambition; no misery worse than discontent; no crime greater than greed. Content of mind is peace and satisfaction eternal. `,
  },
  {
    chapter: 47,
    content: `One need not pass his threshold to comprehend all that is under Heaven, nor to look out from his lattice to behold the Tao Celestial. Nay! but the farther a man goeth, the less he knoweth.
The sages acquired their knowledge without travel; they named all things aright without beholding them; and, acting without aim, fulfilled their Wills. `,
  },
  {
    chapter: 48,
    content: `The scholar seeketh daily increase of knowing; the sage of Tao daily decrease of doing.
...
He who attracteth to himself all that is under Heaven doth so without effort. He who maketh effort is not able to attract it. `,
  ...
  {
    chapter: 49,
    content: `The wise man hath no fixed principle; he adapteth his mind to his environment.
...
The sage appeareth hesitating to the world, because his mind is detached. Therefore the people look and listen to him, as his children; and thus doth he shepherd them. `,
  ...
  {
    chapter: 50,
    content: `Man cometh into life, and returneth again into death.
...
But this I have heard. He that is wise in the economy of his life, whereof he is warden for a season, journeyeth with no need to avoid the tiger or the rhinoceros, and goeth uncorsleted among the warriors with no fear of sword or lance. The rhinoceros findeth in him no place vulnerable to its horn, the tiger to its claws, the weapon to its point. Why is this? Because there is no house of death in his whole body. `,
  ...
  {
    chapter: 51,
    content: `All things proceed from the Tao, and are sustained by its forth-flowing virtue. Every one taketh form according to his nature, and is perfect, each in his particular Way. Therefore, each and every one of them glorify the Tao, and worship its forth-flowing Virtue.
...
It buddeth them forth, and claimeth not lordship over them; it is overseer of their changes, and boasteth not of his puissance; perfecteth them, and interfereth not with their Ways; this is called the Mystery of its Virtue. `,
  },
  {
    chapter: 52,
    content: `The Tao buddeth forth all things under Heaven; it is the Mother of all.
...
Employing harmoniously the Light Within so that it returneth to its Origin, one guardeth even one's body from evil, and keepeth Silence before all men. `,
  ...
  {
    chapter: 53,
    content: `Were I discovered by men, and charged with government, my first would be lest I should become proud.
The true Path is level and smooth; but men love by-paths.
They adorn their courts, but they neglect their fields, and leave their storehouses empty. They wear elaborate and embroidered robes; they gird themselves with sharp swords; they eat and drink with luxury; they heap up goods; they are thievish and vainglorious. All this is opposite to the Way of Tao. `,
  },
  {
    chapter: 54,
    content: `If a man plant according to the Tao it will never be uprooted; if he thus gather, it will never be lost. His sons and his son's sons, one following another, shall honour the shrine of their ancestor.
...
By experience. `,
  ...
  {
    chapter: 55,
    content: `He that hath the Magick powers of the Tao is like a young child. Insects will not sting him or beasts or birds of prey attack him.
...
Things become strong, then age. This is in discord with the Tao, and what is not at one with the Tao soon cometh to an end. `,
  },
  {
    chapter: 56,
    content: `Who knoweth the Tao keepeth Silence; he who babbleth knoweth it not.
...
He cannot be insulted either by familiarity or aversion; he is immune to ideas of gain or loss, of honour or disgrace; he is the true man, unequalled under Heaven. `,
  },
  {
    chapter: 57,
    content: `One may govern a state by restriction; weapons may be used with skill and cunning; but one acquireth true command only by freedom, given and taken.
...
A wise man has said this: I will refrain from doing, and the people will act rightly of their own accord; I will love Silence, and the people will instinctively turn to perfection; I will take no measures, and the people will enjoy true wealth; I will restrain ambition, and the people will attain simplicity. `,
  },
  {
    chapter: 58,
    content: `The government that exerciseth the least care serveth the people best; that which meddleth with everybody's business worketh all manner of harm. Sorrow and joy are bedfellows; who can divine the final result of either?
...
The wise man is foursquare, and avoideth aggression; his corners do not injure others. He moveth in a straight line and turneth not aside therefrom; he is brilliant but doth not blind with his brightness. `,
  ...
  {
    chapter: 59,
    content: `To balance our earthly nature and cultivate our heavenly nature, tread the Middle Path.
...
He who possesseth the Tao continueth long. He is like a plant with well-set roots and strong stems. Thus it secureth long continuance of its life. `,
  },
  {
    chapter: 60,
    content: `The government of a kingdom is like the cooking of fish.
...
When these powers are in accord, their Good Will produceth the Teh, endowing the people therewith. `,
  },
  {
    chapter: 61,
    content: `A state becometh powerful when it resembleth a great river, deep-seated; to it tend all the small streams under Heaven.
...
The great state uniteth men and nurtureth them; the small state wisheth the good will of the great, and offereth service; thus each gaineth its advantage. But the great state must keep Silence. `,
  },
  {
    chapter: 62,
    content: `The Tao is the most exalted of all things. It is the ornament of the good, and the protection and purification of the evil.
...
Why did they of old time set such store by the Tao? Because he that sought it might find it, and because it was the Purification from all evil. Therefore did all men under Heaven esteem it the most exalted of all things. `,
  ...
  {
    chapter: 63,
    content: `Act without lust of result; work without anxiety; taste without attachment to flavour; esteem small things great and few things many; repel violence with gentleness.
...
Who undertaketh thoughtlessly is certain to fail in attainment; who estimateth things easy findeth them hard. The wise man considereth even easy things hard, so that even hard things are easy to him. `,
  ...
  {
    chapter: 64,
    content: `It is easy to grasp what is not yet in motion, to withstand what is not yet manifest, to break what is not yet compact, to disperse what is not yet coherent. Act against things before they become visible; attend to order before disorder ariseth.
...
The wise man willeth what others do not will, and valueth not things rare. He learneth what others learn not, and gathered up what they despise. Thus he is in accord with the natural course of events, and is not overbold in action. `,
  },
  {
    chapter: 65,
    content: `They of old time that were skilled in the Tao sought not to enlighten the people, but to keep them simple.
...
Know these things, and make them thy law and thine example. To possess this Law is the Secret Perfection of rule. Profound and Extended is this Perfection; he that possesseth it is indeed contrary to the rest, but he attracteth them to full accordance. `,
  },
  {
    chapter: 66,
    content: `The oceans and the rivers attract the streams by their skill in being lower than they; thus are they masters thereof. So the Wise Man, to be above men, speaketh lowly; and to precede them acteth with humility.
Thus, though he be above them, they feel no burden; nor, though he precede them, do they feel insulted.
So then do all men delight to honour him, and grow not weary of him. He contendeth not against any man; therefore no man is able to contend against him. `,
  },
  {
    chapter: 67,
    content: `They say that while this Tao of mine is great, yet it is inferior. This is the proof of its greatness. If it were like anything else, its smallness would have long been known.
...
Gentleness bringeth victory in fight; and holdeth its ground with assurance. Heaven wardeth the gentle man by that same virtue. `,
  },
  {
    chapter: 68,
    content: `He that is skilled in war maketh no fierce gestures; the most efficient fighter bewareth of anger. He who conquereth refraineth from engaging in battle; he whom men most willingly obey continueth silently with his Work. So it is said: "He is mighty who fighteth not; he ruleth who uniteth with his subjects; he shineth whose will is that of Heaven."`,
  },
  {
    chapter: 69,
...
There is no error so great as to engage in battle without sufficient force. To do so is to risk losing the gentleness which is beyond price. Thus when the lines actually engage, he who regretteth the necessity is the victor. `,
  ...
  {
    chapter: 70,
    content: `My words are easy to understand and to perform; but is there anyone in the world who can understand them and perform them?
...
Few are they that understand me; therefore am I the more to be valued. The Wise Man weareth sack-cloth, but guardeth his jewel in his bosom. `,
  },
  {
    chapter: 71,
    content: `To know, yet to know nothing, is the highest; not to know, yet to pretend to knowledge, is a distemper.
Painful is this distemper; therefore we shun it. The wise man hath it not. Knowing it to be bound up with Sorrow, he putteth it away from him. `,
  },
  {
    chapter: 72,
    content: `When men fear not that which is to be feared, that which they fear cometh upon them.
...
These things the wise man knoweth, not showeth: he loveth himself, without isolating his value. He accepteth the former and rejecteth the latter. `,
  },
  {
    chapter: 73,
    content: `One man, daring, is executed; another, not daring, liveth. It would seem as if the one course were profitable and the other detrimental. Yet when Heaven smiteth a man, who shall assign the cause thereof? Therefore the sage is diffident.
The Tao of Heaven contendeth not, yet it overcometh; it is silent, yet its need is answered; it summoneth none, but all men come to it of their free will. Its method is quietness, yet its will is efficient. Large are the meshes of Heaven's Net; wide open, yet letting none escape. `,
  },
  {
    chapter: 74,
    content: `The people have no fear of death; why then seek to awe them by the threat of death? If the people feared death and I could put to death evil-doers, who would dare to offend?
There is one appointed to inflict death. He who would usurp that position resembleth a hewer of wood doing the work of a carpenter. Such an one, presumptuous, will be sure to cut his own hands. `,
  },
  {
    chapter: 75,
    content: `The people suffer hunger because of the weight of taxation imposed by their rulers. This is the cause of famine.
The people are difficult to govern because their rulers meddle with them. This is the cause of bad government.
The people welcome death because the toil of living is intolerable. This is why they esteem death lightly. In such a state of insecurity it is better to ignore the question of living than to set store by it. `,
  },
  {
    chapter: 76,
    content: `At the birth of man, he is elastic and weak; at his death, rigid and unyielding. This is the common law; trees also, in their youth, are tender and supple; in their decay, hard and dry.
...
Thus the hard and rigid have the inferior place, the soft and elastic the superior. `,
  ...
  {
    chapter: 77,
    content: `The Tao of Heaven is likened to the bending of a bow, whereby the high part is brought down, and the low part raised up. The extreme is diminished, and the middle increased.
...
Truth appeareth paradox. `,
  ...
  {
    chapter: 79,
    content: `When enemies are reconciled, there is always an aftermath of illwill. How can this be useful?
...
In the Tao of Heaven, there is no distinction of persons in its love; but it is for the True Man to claim it. `,
  },
  {
    chapter: 80,
    content: `In a little kingdom of few people it should be the order that though there were men able to do the work of ten men or five score, they should not be employed. Though the people regarded death as sorrowful, yet they should not wish to go elsewhere.
...
There should be another state within view, so that its fowls and dogs should be heard; yet to old age, even to death, the people should hold no traffic with it. `,
  ...
  {
    chapter: 81,
    content: `True speech is not elegant; elaborate speech is not truth. Those who know do not argue; the argumentative are without knowledge. Those who have assimilated are not learned; those who are gross with learning have not assimilated.
The Wise Man doth not hoard. The more he giveth, the more he hath; the more he watereth, the more is he watered himself.
The Tao of Heaven is like an Arrow, yet it woundeth not; and the Wise Man, in all his Works, maketh no contention. `,
  },
];
