export const text = [
  {
    chapter: 1,
    content: `The Dao that can be stated, is not the eternal Dao;
...
Mystery after Mystery, is the gate to all wonders.`,
  ...
  {
    chapter: 2,
    content: `Everyone knows what beauty is;
...
Only because he does not take credit, and thus the credit does not go away.`,
  ...
  {
    chapter: 3,
    content: `Not to quest for virtuous
...
Maybe it was already created before the creator.`,
  ...
  {
    chapter: 5,
    content: `The sky and the earth do not care,
...
Isn't it because he is selfless,
 therefore he eventually achieve selfness.`,
  ...
  {
    chapter: 8,
    content: `The best quality/character is like water.
...
It is good to be/live on the ground,
 ...
 there will be no blame.`,
  ...
  {
    chapter: 9,
    content: `Rather than pour into a cup overflowed, It is better to stop it.
 ...
 Resigning after succeeding fits with the principle of the universe.`,
  ...
  {
    chapter: 10,
    content: `If soul have been keeping on not being felt by the body,
...
This is called profound virtue.`,
  ...
  {
    chapter: 11,
    content: `Put thirty spokes together to one hub,
...
So the things that are made are only conditions,
 What [we] are using is still the original empty space.`,
  ...
  {
    chapter: 12,
    content: `The beautiful colors blind people's eyes,
...
Therefore, respecting your body over the Universe,
 ...
 then you are worth to take care of the Universe.`,
  ...
  {
    chapter: 14,
    content: `That which is looked at yet never seen is known as invisible,
...
Hold the ancient Dao to know the present things, and thus know the ancient beginnings,
 This is the principle of the Dao.`,
  ...
  {
    chapter: 15,
    content: `Once upon a time, those who knew the Way, were a mysterious and subtle people,
 ...
 Only as they are forever unfulfilled, can such freshness be ever renewed.`,
  ...
  {
    chapter: 16,
    content: `Immersed within the heart of the void, keep tranquility's essence.
...
One could see his body perish without fear.`,
  ...
  {
    chapter: 17,
    content: `Great rulers are hardly known by their subjects,
...
The people will say it happened naturally.`,
  ...
  {
    chapter: 18,
    content: `When the Dao is lost, so there arises benevolence and righteousness.
...
When the state is confused and chaotic, there is loyalty and faithfulness.`,
  ...
  {
    chapter: 19,
    content: `Abandon holiness, relinquish prudence; the people will flourish a hundredfold,
...
Abandon cleverness, relinquish gain; and thieves and robbers will not appear.
 ...
 Lessen the self, diminish desires.`,
  ...
  {
    chapter: 20,
    content: `Discard conventional doctrines and be relieved from anxieties.
...
I find refuge in the womb of this profound conception.`,
  ...
  {
    chapter: 21,
    content: `Where the greatest Virtue resides,
...
By observing things that bestow the Dao.`,
  ...
  {
    chapter: 22,
    content: `Fractured, one asserts unity,
...
With genuine integrity, one rediscovers self.`,
  ...
  {
    chapter: 23,
    content: `Less spoken, words speak for themselves naturally.
...
Explains the disbelief in this futility.`,
  ...
  {
    chapter: 24,
    content: `Ones who tip-toe do not stand,
...
The Dao principles on spontaneity.`,
  },
  {
    chapter: 26,
    content: `Weightiness is the root of weightlessness,
...
Tempestuous, and forfeit mastership.`,
  ...
  {
    chapter: 27,
    content: `Good traveling leaves no tracks;
...
This is the essential mystery!`,
  ...
  {
    chapter: 28,
    content: `Acquire knowledge of extroversions, but
...
Therefore, a great tailor seldom trims.`,
  ...
  {
    chapter: 29,
    content: `It is futile trying to possess the universe,
...
Departs extravagance, departs magnificence.`,
  ...
  {
    chapter: 30,
    content: `Ones who offer advice in the Art of governance,
...
Without being in the Art would die prematurely.`,
  ...
  {
    chapter: 31,
    content: `Where everyone is well armed, is a state in vain,
...
Victories, are remembered in solemness.`,
  ...
  {
    chapter: 32,
    content: `The Dao eternally remain unknowable.
...
Is where rivers merge into oceans.`,
  ...
  {
    chapter: 33,
    content: `Knowing people is being intelligent,
...
Those who die but are not forgotten live on.`,
  ...
  {
    chapter: 34,
    content: `Implications of the Tao are broad and extensive. Ubiquitous!
...
Exploit and it cannot be exhausted.`,
  ...
  {
    chapter: 36,
    content: `If one desires to shrink something, one must indefinitely expand it;
...
Deadly weapons should not be exposed to the people.`,
  ...
  {
    chapter: 37,
    content: `The Dao abides in non-action but there is nothing it does not do.
...
The world would correct by itself.`,
  ...
  {
    chapter: 38,
    content: `Those with great Virtue are not bound by virtues,
...
Therefore, detach from exteriors and embrace interiors.`,
  ...
  {
    chapter: 39,
    content: `When at one with the Dao:
...
And remain composed in grits and gravel.`,
  ...
  {
    chapter: 40,
    content: `Resilience is the Dao in action,
...
Existence is conceived by inexistence.`,
  ...
  {
    chapter: 41,
    content: `The learned discovers the Dao, duly obliges;
...
The Dao is a master of provisioning and empowerment.`,
  ...
  {
    chapter: 42,
    content: `The Dao gives birth to unity,
...
Rarely in this world could anything compare.`,
  ...
  {
    chapter: 44,
    content: `Fame and honor, which is more associable?
...
Know the limitations and be unlimited, be enduring.`,
  ...
  {
    chapter: 45,
    content: `Great support seems deficient,
...
Tranquility makes the world become righteous.`,
  ...
  {
    chapter: 46,
    content: `When the world is with the Dao,
...
Acts not, yet accomplished.`,
  ...
  {
    chapter: 48,
    content: `Practicing scholarships, everyday there is something to gain,
...
Cannot master the universe.`,
  ...
  {
    chapter: 49,
    content: `The master never close up their mind,
...
The master fosters all in innocence.`,
  ...
  {
    chapter: 50,
    content: `Emerging from birth and disappearing into death:
...
These are the intricacies of Virtue.`,
  ...
  {
    chapter: 52,
    content: `The origin of existence began with the mother of all nature.
...
That is practicing the timeless truth.`,
  ...
  {
    chapter: 53,
    content: `That which makes one principled is having knowledge,
...
Not the way of the Dao.`,
  ...
  {
    chapter: 54,
    content: `Proficient builders do not eradicate,
...
By seeing this.`,
  ...
  {
    chapter: 55,
    content: `The profoundness of being embraced with the Virtue,
...
Contradict the Dao, and be brought to an early end.`,
  ...
  {
    chapter: 56,
    content: `Those who know talk not,
...
Therefore it is respected by the universe.`,
  ...
  {
    chapter: 57,
    content: `Be righteous in governance,
...
I yearn not and the people naturally becomes serene.”`,
  ...
  {
    chapter: 58,
    content: `When the governance is idle,
...
Radiant without being glorious.`,
  ...
  {
    chapter: 59,
    content: `In governance and management, nothing compares to being conservative.
...
In the viability and vision of the Dao.`,
  ...
  {
    chapter: 60,
    content: `Governing a nation is like frying small fish.
...
Virtue can hence be returned to another.`,
  ...
  {
    chapter: 61,
    content: `Superior nations are positioned downstream.
...
Therefore the superior stay low.`,
  ...
  {
    chapter: 62,
    content: `The Dao holds the crux to the myriad things,
...
Therefore may continually avoid complications.`,
  ...
  {
    chapter: 64,
    content: `That settled is easily maintained,
...
And not dare act.`,
  ...
  {
    chapter: 65,
    content: `The timeless masters of the Dao,
...
Contra to its objects! And leads towards favorable peacefulness.`,
  ...
  {
    chapter: 66,
    content: `Lakes and oceans can be the master of all streams,
...
Time would have diminished its greatness.`,
  ...
  {
    chapter: 67,
    content: `I have three precious things, that I hold onto and cherish.
...
The heavens will come to your rescue, and protection in its mercy.`,
  ...
  {
    chapter: 68,
    content: `Great gladiators are not violent,
...
That is the ultimate unity with timelessness.`,
  ...
  {
    chapter: 69,
    content: `There is a saying in the battlefield,
...
Those who are reserved are victorious!`,
  ...
  {
    chapter: 70,
    content: `These words are easy to understand, and easy to follow.
...
Hence the master bears humility in apparels and treasuries at heart.`,
  ...
  {
    chapter: 71,
    content: `Knowing that you do not know, is superiority;
...
Hence is void of defectiveness.`,
  ...
  {
    chapter: 72,
    content: `When the people is not threatened by the imposing dignity,
...
Therefore liberated and resolved.`,
  ...
  {
    chapter: 73,
    content: `Courageous in daring and kill,
...
It may be sparse, nothing escapes its netting.`,
  ...
  {
    chapter: 74,
    content: `When people are not threatened by death,
...
Are truly capable of appreciating life.`,
  ...
  {
    chapter: 76,
    content: `People are born gentle and fragile,
...
That is being undesirous in showing-off one's capabilities!`,
  ...
  {
    chapter: 78,
    content: `Of all gentleness and submissiveness in the world
...
Righteous words seem contradictory.`,
  ...
  {
    chapter: 79,
    content: `When hateful hostility is resolved,
...
It will always bring cure to the people.`,
  ...
  {
    chapter: 80,
    content: `A small nation has a small population,
...
People retire of old age without longing to give service to the other.`,
  ...
  {
    chapter: 81,
    content: `Truthful words are not pleasant,
